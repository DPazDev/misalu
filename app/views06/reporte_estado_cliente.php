...
/* Nombre del Archivo: reporte_estado_cliente.php
   Descripción: Realiza la busqueda en la base de datos, para Reporte de Impresión: Relación Estado de los Clientes, de un determinado Ente
*/  
...
titulares.id_ente,entes.id_tipo_ente, 
entes.nombre, clientes.nombres,
titulares.tipocliente

from estados_t_b,estados_clientes,entes,titulares,clientes
...
ORDER BY estados_clientes.estado_cliente,entes.nombre,clientes.nombres,titulares.tipocliente");
...
<table class="tabla_citas"  cellpadding=0 cellspacing=0> 
	<tr>
		<td class="titulo_seccion" colspan="11">Reporte Relación de <?php echo "$tipcliente";?>, <?php 
...
echo"
	...
	<tr>
	        <td colspan=8 class="tdcampos"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Hay un total de <?php if($tipcliente=='TITULARES') echo $t." $tipcliente "."  " . "  ($conti son TITULARES y $conto son TOMADORES)" ; 
...
<tr> <td>&nbsp; </td></tr>
	...
	<?php
		$url="'views06/ireporte_estado_cliente.php?ente=$id_ente@$ente&tipo_ente=$tipo_ente@$nom_tipo_ente&estado=$estado@$estado_cliente&tipcliente=$tipcliente'";
			?> <a href="javascript: imprimir(<?php echo $url; ?>);" class="boton">Imprimir</a>
	<?php
		$url="'views06/excel_estado_cliente.php?ente=$id_ente@$ente&tipo_ente=$tipo_ente@$nom_tipo_ente&estado=$estado&tipcliente=$tipcliente'";
