...
/* Nombre del Archivo: excel_estado_cliente.php
   Descripción: Realiza el Reporte de Impresión en excel con los datos seleccionados: Relación Estado de los Clientes, de un determinado Ente
*/  
...
<table class="tabla_citas"  cellpadding=0 cellspacing=0 > 
	<tr>
		...
		<td class="descrip_main" colspan="7">Reporte Relaci&oacute;n de <?php echo "$tipcliente";?>, <?php if('$estado'=="0") echo "Todos los Estados"; else echo "en Estado "."$f_estado[estado_cliente]";?>,  <?php
