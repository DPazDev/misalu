<?php
   ...
   $cente=$_REQUEST['cualente']; 
   $tipcliente=$_REQUEST['tipclien'];
   $stcliente=$_REQUEST['estclien'];
...
<table class="tabla_citas"  cellpadding=0 cellspacing=0> 
	<tr> 
	      <td class="datos_cliente3" colspan="7">Relaci&oacute;n de <?php echo "$fecre1 al $fecre2";?></td>
	</tr> 
</table>	 	
