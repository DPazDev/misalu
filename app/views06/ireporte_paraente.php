...
procesos.id_titular=titulares.id_titular $condicion_ente $tipo_entes $tipo_entes and titulares.id_ente=entes.id_ente $condicion_proveedor and
...
from para_entes_tmp_$codigo 
group by para_entes_tmp_$codigo.id_proceso,
para_entes_tmp_$codigo.id_beneficiario,
para_entes_tmp_$codigo.fecha_recibido,
para_entes_tmp_$codigo.nombre,
para_entes_tmp_$codigo.id_proveedor,
...
<table class="tabla_citas"  cellpadding=0 cellspacing=0> 
	<tr>
		...
		<td class="descrip_main" colspan="21">Reporte Relaci&oacute;n <?php if($id_servicio==0) echo "TODOS LOS SERVICIOS";
...
if($id_ente=="0") echo "TODOS LOS ENTES";
	...
	<tr> 
		<td class="fecha" colspan=21>Relaci&oacute;n de <?php echo "$fecre1 al $fecre2";?></td>
	</tr> 
	
	<tr> 
		<td class="tdcamposc" colspan=21><?php echo $sucursal?></td>
	</tr>
</table>
...
<?php } 
	if($tipocliente=='TITULAR' or $tipocliente=='BENEFICIARIO' or $tipocliente=='TODOS') { ?>
		...
		<td colspan=2 class="tdcampos">MONTO ACEPTADO</td> 
		<td colspan=2 class="tdcampos">MONTO RESERVA</td>   
...
echo "		<td class=\"tdtituloss\" colspan=19></td>";}
else {
echo"		<td class=\"tdtituloss\" colspan=14></td>";}

echo "			
	<td class=\"tdtituloss\">$frqreportegasto[nom]</td>
	<td class=\"tdtituloss\">$frqreportegasto[descripcion]</td>
	<td colspan=2 class=\"tdtituloss\">".montos_print($frqreportegasto[monto_aceptado])."</td>   
...
<?php if($tipocliente=='TITULAR'){?>
	        ...
	        <td colspan=2 class="tdtituloss">&nbsp;&nbsp; <?php echo montos_print($bsf1); ?>&nbsp;&nbsp;</td>
        <td colspan=1 class="tdtituloss">&nbsp;&nbsp; <?php echo montos_print($bsf2); ?>&nbsp;&nbsp;</td>
<?php }
else{?>
		<td colspan=14 class="tdtitulosd" >Total Bs.S.&nbsp;&nbsp;&nbsp;</td>
	        <td colspan=2 class="tdtitulosd"> <?php echo montos_print($bsf1); ?></td>

	        <td colspan=1 class="tdtitulosd"> <?php echo montos_print($bsf2); ?></td>
<?php }
...
<tr><td Colspan=20>&nbsp; </td></tr>
	<tr>
	        <td  colspan=4 class="descrip_main" >Elaborado Por:____________________</td>
	        <td  colspan=4 class="descrip_main" >Aprobado Por:____________________</td>
		<td  colspan=4 class="descrip_main" >Recibido Por:____________________</td>		
     	</tr>
	<tr><td Colspan=20>&nbsp; </td></tr>
