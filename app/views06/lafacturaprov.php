...
proveedores.id_clinica_proveedor,proveedores.id_s_p_proveedor,tbl_ordenes_compras.ivausado
...
$buscolafa=("select tbl_insumos.insumo,tbl_laboratorios.laboratorio,tbl_tipos_insumos.tipo_insumo,tbl_insumos_ordenes_compras.cantidad,tbl_insumos_ordenes_compras.monto_producto,tbl_insumos_ordenes_compras.monto_unidad,tbl_insumos_ordenes_compras.iva,tbl_insumos_ordenes_compras.aumento from
...
<table class="tabla_cabecera5"  cellpadding=0 cellspacing=0>
 <tr>
    <td class="tdcamposc">Insumo</td>
    <td class="tdcamposc">Tip. Insumo</td>
    <td class="tdcamposc">Marca</td>
    <td class="tdcamposc">Cantidad</td>
	<td class="tdcamposc">Mon. Uni</td>
    <td class="tdcamposc">Mon. Total</td>
    <td class="tdcamposc">Iva</td>
    <td class="tdcamposc">Aumento</td>
  </tr>
      <?
         $totafactura=0;
       ...
       <tr>
             ...
             <td class="tdcamposcc"><?php $togen=$totafactura+$acumuladoriva;
                                                         echo number_format($togen,2,',',''); ?>Bs.S</td>
       </tr>
  </table>
