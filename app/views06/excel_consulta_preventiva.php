...
header("Expires: 0");
/* Nombre del Archivo: excel_consulta_preventiva.php
   Descripción: Realiza el Reporte de Impresión en excel con los datos seleccionados: Relación Consultas Preventivas
*/ 
...
<?php if($f_cliente['id_cliente']==$f_ti['id_cliente']){
	...
	$q_titular=("select clientes.id_cliente, clientes.nombres, clientes.apellidos, clientes.cedula, titulares.id_cliente, titulares.id_titular, titulares.id_ente, entes.nombre,estados_clientes.estado_cliente from estados_clientes, clientes, titulares, entes where clientes.cedula='$ci' and
...
<td class="tdtitulos">Estado:</td>
	...
	<tr>
		<td class="tdtituloss">Las Consultas Preventivas del Cliente son:</td>
	</tr>
</table>
