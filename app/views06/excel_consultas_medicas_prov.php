<?php
/* Nombre del Archivo: excel_consultas_medicas_prov.php
   Descripción: Realiza la busqueda en la base de datos, para el Reporte en excel: Morbilidad de los Proveedores Persona y Clinicas
*/  
...
$a=", personas_proveedores.nombres_prov";
$b=" order by personas_proveedores.nombres_prov";
$condicion_fecha="and procesos.fecha_cita between '$fecre1' and '$fecre2'";} 
...
<table class="tabla_citas"  colspan=19 cellpadding=0 cellspacing=0 border=0> 
	<tr> 
		...
		<td class="tdcampos" colspan=2>TOTAL</td>
</tr>
...
<?php echo" 
	...
	<td colspan=2  class=\"tdtitulos\">$freporte[count]</td>";?></tr>
