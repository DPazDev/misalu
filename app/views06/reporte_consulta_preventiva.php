...
<tr>
		<td class="titulo_seccion" colspan="7">Reporte Relaci&oacute;n Consultas Preventivas del Cliente como Titular</td>     
	</tr>
	<tr> 
		<td >&nbsp;</td>
	</tr>
	<tr> 
		<td class="tdtitulosd" colspan=7>Relaci&oacute;n del <?php echo " $fecha1 al $fecha2 ";?>&nbsp;</td>
	</tr>
	<tr> 
		<td >&nbsp;</td>
	</tr>
	...
	<tr> 
		<td class="tdtitulos" colspan=7>&nbsp; Las Consultas Preventivas del Cliente son:</td>
	</tr>
...
<table class="tabla_citas"  cellpadding=0 cellspacing=0 rules="rows"> 
	...
	<tr> 
		...
		<td class="tdcampos">ESPECIALIDAD MEDICA</td> 
		<td class="tdcampos">DESCRIPCION</td>  
		<td class="tdcampos" colspan=2 >ANALISIS TECNICO</td> 
...
echo"
	...
	<tr>
	        <td colspan=7 class="tdcampos" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Hay un total de <?php echo $i; ?> Consultas Preventivas  </td>
...
?>
	<tr>
		<td class="titulo_seccion" colspan="7">Reporte Relaci&oacute;n Consultas Preventivas del Cliente como Beneficiario </td>     
	</tr>
	<tr> 
		<td >&nbsp;</td>
	</tr>
...
<table>
	<tr>
	        <td colspan=7 class="tdcamposs" title="Imprimir reporte">
			  <?php
			$url="'views06/ireporte_consulta_preventiva.php?fecha1=$fecha1&fecha2=$fecha2&ci=$ci'";
