...
$q_tit_ben=("select clientes.id_cliente, clientes.nombres, clientes.apellidos, clientes.cedula, titulares.id_cliente, titulares.id_titular, titulares.id_ente, entes.nombre from clientes, titulares, entes where clientes.cedula=$ci and
titulares.id_cliente=clientes.id_cliente and
titular.id_titular=$beneficiario[id_titular] and
titulares.id_ente=entes.id_ente");
...
<?php if($tipcliente=='BENEFICIARIO'){
		while($f_beneficiario=asignar_a($r_beneficiario,NULL,PGSQL_ASSOC)){

?>

	<tr> 
		<td class="tdtituloss">Nombre y Apellido del Titular:&nbsp;&nbsp;&nbsp; <?php echo "$f_tit_ben[nombres] $f_titular[apellidos]";?></td>
	</tr>

<tr> 
		<td class="tdtituloss">C&oacute;digo:&nbsp;&nbsp;&nbsp; <?php echo "$f_tit_ben[id_titular]"; ?></td>
	</tr>

<tr> 
		<td class="tdtituloss">C&eacute;dula del Titular:&nbsp;&nbsp;&nbsp; <?php echo "$f_tit_ben[cedula]" ;?></td>
	</tr>
<tr> 
		<td class="tdtituloss">Ente:&nbsp;&nbsp;&nbsp; <?php echo "$f_tit_ben[nombre]";?></td>
	</tr>
<tr>
	<tr> 
		<td class="tdtituloss">Nombre y Apellido del Beneficiario:&nbsp;&nbsp;&nbsp; <?php echo "$f_beneficiario[nombres] $f_beneficiario[apellidos]";?></td>
	</tr>

<tr> 
		<td class="tdtituloss">C&oacute;digo:&nbsp;&nbsp;&nbsp; <?php echo "$f_beneficiario[id_beneficiario]"; ?></td>
	</tr>

<tr> 
		<td class="tdtituloss">C&eacute;dula del Beneficiario:&nbsp;&nbsp;&nbsp; <?php echo "$f_beneficiario[cedula]" ;?></td>
	</tr>
<tr> 
		<td class="tdtituloss">Ente:&nbsp;&nbsp;&nbsp; <?php echo "$f_titular[nombre]";?></td>
	</tr>
...
?>
	...
	<tr>
	        <td colspan=7 class="tdtituloss">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Hay un total de <?php echo $i-1; ?> Consultas Preventivas) </td>
...
<br>
	...
	<tr>
	        <td colspan=9 class="tdcamposs" title="Imprimir reporte">
			  <?php
			$url="'views06/ireporte_entpriv.php?fecha1=$fecre1&fecha2=$fecre2&ci=$ci&tipcliente=$tipcliente'";
