...
/* Nombre del Archivo: rep_ingreso_emergencia.php
...
<table class="tabla_citas"  cellpadding=0 cellspacing=0> 
	...
	<tr>
		<td class="titulo_seccion" colspan="26">Reporte Relaci&oacute;n INGRESOS POR <?php if($id_servicio==0) echo "TODOS LOS SERVICIOS";
...
$planilla1="$freporte1[nu_planilla]";//se recarga la variable con el valor del select
...
$bsf2t= $bsf2t+($frqreportegasto[monto_reserva]);
 ...
 if($tipocliente=='TITULAR'){
  $sump=$bsf1;
  ?>
	        <td colspan=11 class="tdtitulosd" > Total Bs.S.&nbsp;</td>
...
<tr><td colspan=16>&nbsp;</td></tr>
	   ...
	   <tr>
	        <td colspan=6 class="tdtituloss" >&nbsp;&nbsp;&nbsp;&nbsp; Hay un total de <?php echo $pla-1; ?> Usuarios </td>
	   </tr>
...
<tr>
 <td colspan=11 class="tdcamposs" title="Imprimir reporte">
			  <?php
			$url="'views06/irep_ingreso_emergencia.php?sucur=$id_sucursal@$sucursal&servic=$id_servicio@$servicio&ente=$id_ente@$ente&tipo_ente=$tipo_ente@$nom_tipo_ente&estapro=$id_estado@$estado_proceso&fecha1=$fecre1&fecha2=$fecre2&tipcliente=$tipocliente&proveedor=$proveedor&inicio=$inicio&fin=$fin'";
