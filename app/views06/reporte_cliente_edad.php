...
/* Nombre del Archivo: reporte_cliente_edad.php
   Descripción: Realiza la busqueda en la base de datos, para Reporte de Impresión: Relación de Clientes entre A y B años, de un Ente en Particular.
*/ 
...
<tr><td colspan=9>&nbsp;</td></tr>
	...
	<tr> <td>&nbsp;</td></tr>
	<tr>
	        <td colspan=9 class="tdcampos" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; HAY UN TOTAL DE <?php if($tipcliente=='TITULARES') echo $t." $tipcliente"; 
...
<table>
	...
	<?php
		$url="'views06/ireporte_cliente_edad.php?ente=$id_ente@$ente&tipo_ente=$tipo_ente@$nom_tipo_ente&inicio=$inicio&fin=$fin&tipcliente=$tipcliente&estado=$estado@$estado_cliente'";
			?> <a href="javascript: imprimir(<?php echo $url; ?>);" class="boton">Imprimir</a> <?php
		$url="'views06/excel_cliente_edad.php?ente=$id_ente@$ente&tipo_ente=$tipo_ente@$nom_tipo_ente&inicio=$inicio&fin=$fin&tipcliente=$tipcliente&estado=$estado@$estado_cliente'";
