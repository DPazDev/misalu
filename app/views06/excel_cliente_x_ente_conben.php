...
/* Nombre del Archivo: ireporte_cliente_x_ente_conben.php
...
$objPHPExcel->getActiveSheet()->setCellValue('A3', "Reporte Relación Clientes Titulares en Estado $estado_clientet y Beneficiarios en Estado $estado_clienteb, del Tipo de Ente $nom_tipo_ente, del Ente $ente. Con Fecha de Inclusión del $fecha1 al $fecha2");
...
$objPHPExcel->getActiveSheet(0)->setCellValue("H".$i, 'CLIENTE');
...
$objPHPExcel->getActiveSheet(0)->setCellValue("P".$i, 'FECHA INCLUSION');
$objPHPExcel->getActiveSheet(0)->setCellValue("Q".$i, 'COMENTARIO');
$objPHPExcel->getActiveSheet(0)->setCellValue("R".$i, 'TELEFONO');
$objPHPExcel->getActiveSheet(0)->setCellValue("S".$i, 'CELULAR');
$objPHPExcel->getActiveSheet(0)->setCellValue("T".$i, 'ENTE');
...
$objPHPExcel->getActiveSheet(0)->setCellValueExplicit("P".$i, $f_titular[fecha_inclusion], PHPExcel_Cell_DataType::TYPE_STRING);
$objPHPExcel->getActiveSheet(0)->setCellValueExplicit("Q".$i, $f_titular[comentarios], PHPExcel_Cell_DataType::TYPE_STRING);
$objPHPExcel->getActiveSheet(0)->setCellValueExplicit("R".$i, $f_titular[telefono_hab], PHPExcel_Cell_DataType::TYPE_STRING);
$objPHPExcel->getActiveSheet(0)->setCellValueExplicit("S".$i, $f_titular[celular], PHPExcel_Cell_DataType::TYPE_STRING);
$objPHPExcel->getActiveSheet(0)->setCellValueExplicit("T".$i, $f_titular[nombre], PHPExcel_Cell_DataType::TYPE_STRING);
...
$objPHPExcel->getActiveSheet(0)->setCellValueExplicit("P".$i, $f_beneficiario[fecha_inclusion], PHPExcel_Cell_DataType::TYPE_STRING);
$objPHPExcel->getActiveSheet(0)->setCellValueExplicit("Q".$i, $f_beneficiario[comentarios], PHPExcel_Cell_DataType::TYPE_STRING);
$objPHPExcel->getActiveSheet(0)->setCellValueExplicit("R".$i, $f_beneficiario[telefono_hab], PHPExcel_Cell_DataType::TYPE_STRING);
$objPHPExcel->getActiveSheet(0)->setCellValueExplicit("S".$i, $f_beneficiario[celular], PHPExcel_Cell_DataType::TYPE_STRING);
$objPHPExcel->getActiveSheet(0)->setCellValueExplicit("T".$i, $f_titular[nombre], PHPExcel_Cell_DataType::TYPE_STRING);
...
$objPHPExcel->getActiveSheet()->getStyle('A6:Z6')->applyFromArray(
		array(
			'font'    => array(
				'bold'      => true
			),
