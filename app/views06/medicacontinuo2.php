...
&nbsp;&nbsp;&nbsp; </span>
    <table class="tabla_citas"  cellpadding=0 cellspacing=0>
         <tr>
          <td colspan=4 class="datos_cliente3"><? echo"Medicamentos entregados al  ente/s $nomente en el rango del $fecha1 al $fecha2 dirigido a los $nomcliente, cuyo estado proceso es $nomestproc";?> </td>
         </tr>
        </table>
    <table class="tabla_citas"  cellpadding=0 cellspacing=0>
     <tr>
        <th class="datos_cliente3">No.</th>
        <th class="datos_cliente3">No. Proceso</th>
        <th class="datos_cliente3">Operador.</th>
        <th class="datos_cliente3">Estatus.</th>
	    <th class="datos_cliente3">Titular.</th>
        <th class="datos_cliente3">Beneficiario.</th>
        <th class="datos_cliente3">Medicamento.</th>
		<th class="datos_cliente3">Cantidad.</th> 
        <th class="datos_cliente3">Monto.</th>
        <th class="datos_cliente3">Tratm Cont.</th>
		<th class="datos_cliente3">Fecha Cont.</th>
	</tr>
	    ...
	    <?php  
				...
				?>
	                ...
	                <td class="cantidades"><?echo $elproceso;?></td> 
	                <td class="cantidades"><?echo "$datosconti[nombres]  $datosconti[apellidos]";?></td> 
					<td class="cantidades"><?echo "$datosconti[estado_proceso]";?></td>  
					<td class="cantidades"><?echo $nomcpltitu;?></td>  
					<td class="cantidades"><?echo $nomcplbeni;?></td>  
                   </tr>
					<?
		...
		?>
				   ...
				   <tr>
						...
						<td class="cantidades"></td>
						<td class="cantidades"></td>
						 <td class="cantidades"><? if($datosgstb[descripcion]<>''){
						                                    
															echo $datosgstb[descripcion];?></td>
						 <td class="cantidades"><?echo $datosgstb[unidades];?></td> 
						 <td class="cantidades"><?echo $datosgstb[monto_reserva];?></td>  
						 <td class="cantidades"><?echo $estcon;?></td>  
						<td class="cantidades"><?echo $datosgstb[fecha_continuo ];
						  }
						 ?></td>   
					</tr>
		...
		?>
		            <tr>
						...
						<td class="cantidades"></td>
						<td class="cantidades"></td> 
						<td class="cantidades"><label style="color: #000000">Total medicamentos</label></td> 
						<td class="cantidades"><label style="color: #000000"><?echo $totalme;?></label></td>  
						 <td class="cantidades"><label style="color: #000000">Total Bs.S.f</label></td> 
						 <td class="cantidades"><label style="color: #000000"><?echo $totalcost;?></label></td>
	          ...
	          <tr>
						...
						<td class="cantidades"></td>
						<td class="cantidades"></td> 
						<td class="cantidades"><label style="color: #000000">Total general medicamentos</label></td> 
						<td class="cantidades"><label style="color: #000000"><?echo $totalgme;?></label></td>  
						 <td class="cantidades"><label style="color: #000000">Total general Bs.S</label></td> 
						 <td class="cantidades"><label style="color: #000000"><?echo $totalgcost;?></label></td>
					 </tr>  
	 </table> 
<?}?>
