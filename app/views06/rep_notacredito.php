...
$r_ente=pg_query("select * from  entes where id_tipo_ente>0  order by nombre");
...
<form action="" method="POST" name="rep_factura" target="_blank">
<table class="tabla_cabecera3"  cellpadding=0 cellspacing=0>
	<tr>
		<td colspan=4 align="center" class="titulo_seccion">Relacion  de Notas de Creditos&nbsp;</td>
	</tr>
...
<img src="../public/images/calendar.gif" class="cp_img" alt="Seleccione la Fecha"></a>
	...
	<td width="80" class="tdtitulos" >
	  	    Seleccione el ente	    </td>
			<td>
	      <select style="width: 300px;"  id="ente" name="ente" class="campos">
		  <option value="0">Todos los Entes </option>
            <?php
	while($f_ente=pg_fetch_array($r_ente, NULL, PGSQL_ASSOC))
	...
	<td width="80" class="tdtitulos" >
	  	    Seleccione el ente	    </td>
			<td>
	      <select id="sucursal" name="sucursal" class="campos">
	...
	<td class="tdcampos"><input class="campos" type="hidden" name="vacio" maxlength=128 size=20 value=""><a href="#" OnClick="bus_rep_nc();" class="boton">Buscar</a>
	<a href="#" OnClick="bus_rep_excel_notacredito();" <img border="0" src="../public/images/excel.jpg"></a> 
	<a href="#" OnClick="ir_principal();" class="boton">Salir</a></td>  
	</tr>  
</table>
<div id="bus_rep_nc"></div>
</form>
