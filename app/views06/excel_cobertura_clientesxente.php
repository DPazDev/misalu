...
/* Nombre del Archivo: excel_cobertura_clientesxente.php
   Descripción: Realiza el Reporte de Impresión en excel con los datos seleccionados: Relación de Cobertura de los Clientes Totales, de un determinado Ente
*/  
...
<table class="tabla_citas"  cellpadding=0 cellspacing=0 >
	...
	<tr>
		...
		<td class="descrip_main" colspan="12">Reporte Relaci&oacute;n Clientes Titulares <?php 
...
<?php
	echo"
		<tr>
		<td class=\"tdtitulos\" colspan=5>&nbsp;&nbsp;&nbsp; Le queda   				$f_titular[cualidad] &nbsp;";?> <?php echo montos_print($f_titular['monto_actual'])." Bs.S.";?></td>
		<td colspan=1>&nbsp;</td>
                <td colspan=1>&nbsp;</td>
                <td colspan=1>&nbsp;</td>
                <td colspan=1>&nbsp;</td>
...
?></td>
	...
	<?php echo"
		...
		<td class=\"tdtituloss\" colspan=1 >&nbsp;</td>
			...
			<td class=\"tdtitulos\" colspan=7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Le queda en $f_beneficiario[cualidad] &nbsp;";?> <?php echo montos_print($f_beneficiario['monto_actual'])." Bs.S.";?></td>
		</tr>

<?php if ($f_beneficiario['cualidad']=='MATERNIDAD') {
	$b=$b-1;}}}?>
<tr>
