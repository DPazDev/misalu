...
<table   border=0 class="tabla_citas"  cellpadding=0 cellspacing=0>
  ...
  <tr>
    <td colspan="9" class="titulo_seccion"> Gastos  </td>
  </tr>
  <tr>
...
<?php
	$q_proceso = "select clientes.nombres,clientes.apellidos,clientes.cedula,procesos.id_proceso,
    procesos.id_estado_proceso,procesos.fecha_recibido,procesos.id_titular,procesos.id_beneficiario,
    entes.nombre ,count(gastos_t_b.id_proceso) from procesos,clientes,gastos_t_b,entes,
    titulares where $procesado procesos.donativo='$donativo' and 
    procesos.fecha_recibido>='$dateField1' and procesos.fecha_recibido<='$dateField2' and 
    procesos.id_titular=titulares.id_titular and titulares.id_cliente=clientes.id_cliente and 
    titulares.id_ente=entes.id_ente and procesos.id_proceso=gastos_t_b.id_proceso 
    group by clientes.nombres,clientes.apellidos,clientes.cedula,procesos.id_proceso,
    procesos.id_estado_proceso,procesos.fecha_recibido,procesos.id_titular,procesos.id_beneficiario,
    entes.nombre";
...
?>
  ...
  <tr>
	<td class="tdcampos"><?php echo $f_proceso[id_proceso]?></td>  
    <td class="tdcampos"><?php echo "$f_proceso[nombres] $f_proceso[apellidos]"?></td>
    <td class="tdcampos"><?php echo $f_proceso[cedula]?></td>	
    <td class="tdcampos"><?php echo $nombre?></td>
    <td class="tdcampos"><?php echo $cedula?></td></td>
	 <td class="tdcampos"><?php echo $f_proceso[nombre]?></td>
    <td class="tdcampos"><?php echo $f_proceso[fecha_recibido]?></td>
	<td class="tdcampos"><?php echo $descripcion?></td>
	<td class="tdcampos"><?php echo formato_montos($monto)?></td>
  </tr>
<?php
}
?>
...
?>
  ...
  <tr>
	<td class="tdcampos"><?php echo $f_donativo[no_orden_donativo]?></td>  
    <td class="tdcampos"><?php echo "$f_donativo[nombres] $f_donativo[apellidos]"?></td>
    <td class="tdcampos"><?php echo $f_donativo[cedula]?></td>	
    <td class="tdcampos"><?php echo $nombre?></td>
    <td class="tdcampos"><?php echo $cedula?></td></td>
	 <td class="tdcampos"><?php echo $f_donativo[nombre]?></td>
    <td class="tdcampos"><?php echo $f_donativo[fecha_donativo]?></td>
	<td class="tdcampos"><?php echo $f_donativo[comentarios]?></td>
	<td class="tdcampos"><?php echo formato_montos($montod)?></td>
  </tr>
<?php
}
?>
...
<tr>
	...
	<td class="tdcamposc"><?php echo formato_montos($montot + $montodt)?></td>
 </tr>
<tr>
    ...
    <td class="tdcamposc"></td>	
    <td class="tdcamposc"></td>
	    <td class="tdcamposc">Monto a Cumplir</td>
	<td class="tdcamposc"><?php echo formato_montos($f_var[cantidad])?></td>
 </tr> 
<tr>
    ...
    <td class="tdcamposc"></td>	
    <td class="tdcamposc"></td>
	    <td class="tdcamposc">Resta</td>
	<td class="tdcamposc"><?php echo formato_montos($f_var[cantidad] - ($montot + $montodt))?></td>
 </tr>  
<tr>
    <td colspan="9" class="titulo_seccion"> <?php
$url="'views06/iressocial.php?dateField1=$dateField1&dateField2=$dateField2&procesado=$procesadot'";
