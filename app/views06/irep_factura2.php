...
list($ano1,$mes1,$dia1)=explode("-",$fechafin);
...
<td colspan=6 class="titulo1">
<?php echo "$f_admin[sucursal] $fechafin "?>
</td>
</tr>
<tr>
<td >
...
?>
   ...
   <tr>
  <td height="21" colspan="14" class="titulo_seccion"><div align="left"><strong>Relacion de Facturas Emitidas desde <?php  echo "$dia-$mes-$ano"; ?>
        al <?php echo "$dia1-$mes1-$ano1" ?> de la <?php echo $nom_ente?> </strong></div></td>
    </tr>
       

    	<tr>
      <td height="21" colspan="14" class="Estilo3"><div align="left"><strong><?php  echo "Condicion de la Factura    $descripcion" ?></div></td>
    </tr>
...
($f_ente=pg_fetch_array($r_ente, NULL, PGSQL_ASSOC))
 ...
 if ($forma_pago==4){
	...
	<td     class="tdcamposcc">  </td>
 	...
 	<td    class="tdcamposcc"> <?php echo montos_print($totalmontpag - $f_deducible[fac_deducible])?></td>
            <?
            }
            else
            {
...
<td class="titulo3" ><?php echo  montos_print($totalmontpag1 - $totaldeducible)?></td>
</tr>
...
<?php
 if ($forma_pago<>4){
     ?>
 <tr>
      <td height="21" colspan="14" valign="top"><div align="left" class="Estilo3">Recibi Conforme <?php echo "$contador  $f_ente[nombre]"?>:_________________</div>
      </td>
      </tr>
       <tr>
      <td height="21" colspan="14" valign="top"><div align="left" class="Estilo3">Entregado Por:_________________</div>
      </td>
      </tr>
     <?php
     }
