...
//echo"<h1>repprove:$repprove sucrepo:$sucrepo repservi:$repservi replogo:$replogo restpro:$restpro cualesp:$cualesp</h1>";
   ...
   $vertipoadmin=("select admin.id_admin,admin.id_tipo_admin,id_departamento from admin where id_admin=$elid and (admin.id_tipo_admin=4 or admin.id_tipo_admin=7);");
    $repvertipoadmin=ejecutar($vertipoadmin);
    $cuantipoadmin=num_filas($repvertipoadmin);
    $PermisosAdmin=assoc_a($repvertipoadmin);
///Permisos de Administrativo
 $ElIdadmin=$PermisosAdmin['id_admin'];
 $TipoUsuario=$PermisosAdmin['id_tipo_admin'];
 $DepartamentoUsuario=$PermisosAdmin['id_departamento'];
   ...
   if($repservi<100){
    ...
    //SEGUNDA consultar
    $sucrepo2=$querysucursal;
    $repservi2=$queryservi;
...
<table class="tabla_citas"  cellpadding=0 cellspacing=0 border=1>
	<tr>
	   ...
	   <td class="tdtituloss">Fecha ord. creada</td>
	     ...
	     while($repprov=asignar_a($resultarepor,NULL,PGSQL_ASSOC)){
		  ...
		  echo"
            <tr>
				...
				<td class=\"tdtituloss\">$repprov[fecha_creado]</td>
               ...
               <td class=\"tdtituloss\">$repprov[control_factura]</td>
	            ...
	            <td class=\"tdtituloss\">$lainftitular[nombre]</td>
	...
	<tr>
			...
			?> <a href="javascript: imprimir(<?php echo $url; ?>);" class="boton">Imprimir</a>
                      ...
                      <?
                         if($restpro<>11){
                           ////permisos de usuario Administrativo id_modulo=1
                           $permisossql=("select permisos.id_modulo,id_admin,permiso from permisos where id_modulo='1' and permisos.permiso=1 and permisos.id_admin=$elid;");
                             $permisos=ejecutar($permisossql);
                             $cuantosPermisos=num_filas($permisos);
                          ...
                          if( ($cuantosPermisos>0) && ($TipoUsuario=='7' || $TipoUsuario=='4' || $TipoUsuario=='1'))
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
<?php }  else{
	echo $queryorden=("select procesos.id_proceso,procesos.fecha_creado,procesos.id_titular,procesos.id_beneficiario,
							...
							procesos.id_proceso=gastos_t_b.id_proceso and
							procesos.id_estado_proceso=$restpro and
							procesos.fecha_recibido between '$fecre1' and '$fecre2' $repservi2 and procesos.id_admin=admin.id_admin $sucrepo2 and gastos_t_b.id_proveedor=$repprove group by procesos.id_proceso,procesos.fecha_creado,procesos.id_titular,
