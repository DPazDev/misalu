...
<table class="tabla_citas"  cellpadding=0 cellspacing=0> 
	<tr>
		<td class="titulo_seccion" colspan="16">Reporte Relaci&oacute;n Clientes Titulares con Beneficiarios <?php 
...
$q_titular=("select 
	...
	from 
	entes,clientes, estados_clientes, estados_t_b, titulares, titulares_subdivisiones,beneficiarios
	where 
...
<br>
	...
	<?php
		$url="'views06/ireporte_cliente_x_ente_conben.php?fecha1=$fecha1&fecha2=$fecha2&ente=$id_ente@$ente&tipo_ente=$tipo_ente@$nom_tipo_ente&estadot=$estadot@$estado_clientet&estadob=$estadob@$estado_clienteb&subdivi=$subdivi'";
			?> <a href="javascript: imprimir(<?php echo $url; ?>);" class="boton">Imprimir</a>
<?php
		$url="'views06/excel_cliente_x_ente_conben.php?fecha1=$fecha1&fecha2=$fecha2&ente=$id_ente@$ente&tipo_ente=$tipo_ente@$nom_tipo_ente&estadot=$estadot@$estado_clientet&estadob=$estadob@$estado_clienteb&subdivi=$subdivi'";
