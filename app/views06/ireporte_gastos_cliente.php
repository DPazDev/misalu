...
*/
	...
	$q_poliza=("select coberturas_t_b.id_cobertura_t_b,coberturas_t_b.id_titular,coberturas_t_b.id_beneficiario,propiedades_poliza.*, polizas.nombre_poliza, propiedades_poliza.id_poliza 
...
<?php $q_titular=("select clientes.id_cliente, clientes.nombres, clientes.apellidos, clientes.cedula,
			titulares.id_titular, titulares.id_ente,entes.nombre, estados_clientes.estado_cliente			
...
<tr> 
	...
	?>
		...
		<td class="descrip_main" colspan=5>&nbsp; Cobertura: <?php echo montos_print($monto1)." Bs.S.";?> Saldo Disponible: <?php echo montos_print($monto1 - $total_gastos)." Bs.S.";?> </td>
		<?php
	}
	?>
		<td class="descrip_main" colspan=2>&nbsp; Hay un total de <?php echo $i;?> Ordenes </td>
	</tr> 
	<tr>	<td colspan=7>&nbsp;</td>
	<br>
	<tr>	<td colspan=7>&nbsp;</td>
	...
	<tr>
		...
		<td  colspan=2 class="tdtituloss" >Recibido Por:____________________</td>
