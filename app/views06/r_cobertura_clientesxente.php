<?php
/* Nombre del Archivo: r_cobertura_clientesxente.php
   Descripción: Solicitar los datos para Reporte de Impresión: Relación de Coberturas de los Clientes Totales, de un determinado Ente */
...
?>
 ...
 <form method="POST" name="r_coberturaclientexente" id="r_coberturaclientexente">

    <table class="tabla_cabecera3"  cellpadding=0 cellspacing=0>

	<tr>
		<td colspan=4 class="titulo_seccion">Relaci&oacute;n Coberturas Clientes Totales, de un determinado Ente.</td>
	</tr>
	<tr> <td colspan=4>&nbsp;</td></tr>
	<tr>
	
	
	       <td class="tdtitulos" colspan="1">* Estado del Titular:</td>
	       <td class="tdcampos"  colspan="1"><select name="estadot" class="campos"  style="width: 210px;" >
				     ...
				     <option value="<?php echo $f_estado['id_estado_cliente']?>"> <?php echo "$f_estado[estado_cliente]"?></option>
				    <?php
				    }?> 
		</td>

 		<td class="tdtitulos" colspan="1">* Estado del Beneficiario:</td>
...
<div id="bus_ent"></div>
	...
	<tr>
		<td colspan=4 class="tdcamposcc"> <a href="#" OnClick="imp_cobertura_clientesxente();" class="boton">Imprimir</a>  <a href="#" OnClick="ir_principal();" class="boton">Salir</a></td>

	</tr>
	<tr> <td colspan=4>&nbsp;</td></tr>
</table>
<div id="reporte_cobertura_clientesxente"></div>
</from>
