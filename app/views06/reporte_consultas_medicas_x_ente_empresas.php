...
<table class="tabla_citas"  cellpadding=0 cellspacing=0> 
	<tr>
		<td class="titulo_seccion" colspan="19">Consultas M&eacute;dicas por Entes, Empresas Autorizadas, Relaci&oacute;n Orden de Atenci&oacute;n y Emergencias con Fecha de Cita</td>
</table>	
 <br>
...
where   gastos_t_b.id_proceso=procesos.id_proceso and 
	gastos_t_b.fecha_cita between '$fecha1' and '$fecha2' and 
...
while($freporte=asignar_a($rreporte,NULL,PGSQL_ASSOC))
	    ...
	    $url="views06/ireporte_consultas_medicas_x_ente_empresas.php?fecha1=$fecha1&fecha2=$fecha2&estado=$estado&especialidad=$freporte[id_especialidad_medica]";
                        ?>
<tr>
<?php
echo"
