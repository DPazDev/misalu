...
/* **** creamos la tabla temporal para realizar la consulta**** */
 $q_tabla_tem = "create table 
								...
								where 
										...
										$sucursales
										and procesos.id_titular=titulares.id_titular and 
...
/* **** Seleccionamos los estados del Proceso para Realizar la busqueda por Estado del Proceso**** */
 $q_edopro = "select 
									* 
							from 
									estados_procesos 
...
?>
  <tr>
    <td colspan="6" class="titulo_seccion"> Gastos de <?php echo  "$tipo  estado $f_edopro[estado_proceso]";?> </td>
  </tr>
  <tr>
	<td class="tdcamposc">Servicios</td>  
    <td class="tdcamposc">Cantidad</td>
    <td class="tdcamposc">Monto Reserva</td>	
    <td class="tdcamposc">Monto Aceptado</td>
    <td class="tdcamposc">% Frecuencia Sini.</td>
...
$q_gastos = "select 
 ...
 ";
	...
	<tr>
    <td class="tdcamposcc"><?php echo $f_servicios[servicio];?></td>
	<td class="tdcamposcc"><?php echo $num_filas1;?></td>
    <td class="tdcamposcc"><?php echo montos_print($montor);?></td>	
        <td class="tdcamposcc"><?php echo montos_print($monto);?></td>	
    <td class="tdcamposcc"><?php echo montos_print(($num_filas1 / $num_filas) * 100 );?></td>
...
<tr>
	...
	<td class="tdcamposc"><?php echo $num_filas;?></td>
    <td class="tdcamposc"><?php echo montos_print($montor1);?></td>	
    <td class="tdcamposc"><?php echo montos_print($monto1);?></td>	
    <td class="tdcamposc"><?php echo montos_print (($num_filas / $num_filas) * 100 );?></td>
	<td class="tdcamposc"></td>
 </tr>
 <?php
 }
...
$re_tabla_tem = ejecutar($e_tabla_tem);
 ...
 <tr>
    ...
    <td class="tdcamposc"><?php echo montos_print($montor2);?></td>	
    <td class="tdcamposc"><?php echo montos_print($monto2);?></td>	
    <td class="tdcamposc"><?php echo montos_print (($num_filas / $num_filas) * 100 );?></td>
	<td class="tdcamposc"></td>
 </tr>
<tr>
    <td colspan="6" class="titulo_seccion"> </td>
      ...
      <tr>
    <td colspan="6" class="titulo_seccion"> Formula </td>
  </tr>
  <tr>
    <td colspan="6" class="tdcamposcc"><?php echo " Siniestros Pendientes ($siniestro_pen) + Siniestros Pagados ( $siniestro_pag)=$monto2 ";?></td>
