<?php
/* Nombre del Archivo: reporte_contrato_anulado.php
   Descripción: Realiza la busqueda en la base de datos, para el Reporte de Impresión: Contrato anulado de las Ventas de Polizas Individuales
*/  
...
<table class="tabla_citas"  cellpadding=0 cellspacing=0> 
	...
	<tr> <td colspan=4>&nbsp;</td></tr>
	<tr>
		<td class="titulo_seccion" colspan="19">REPORTE CONTRATOS ANULADOS DE LA VENTA DE POLIZAS INDIVIDUALES CON FECHA DE VIGENCIA DE CONTRATO DESDE EL <?php echo "$fecre1 AL $fecre2";?>  </td>
...
<table class="tabla_citas"  cellpadding=0 cellspacing=0  border=3> 
	...
	<td class="tdcampos">&nbsp;ANULADO &nbsp;</td>
	<td class="tdcampos">&nbsp;FECHA ANULADO &nbsp;</td>
</tr>
...
$q_venta=("select 
	...
	from entes,articulocontrato,tbl_contrato_anulado, clientes,titulares, tbl_contratos_entes, tbl_recibo_contrato, comisionados, tbl_caract_recibo_prima, primas, polizas,admin 
	where 
	...
	group by
	articulocontrato.nombre_articulo,entes.nombre, clientes.cedula, a,
	 b,	titulares.tipocliente,
	tbl_contratos_entes.numero_contrato,tbl_contratos_entes.id_contrato_ente, 
	tbl_recibo_contrato.fecha_ini_vigencia, tbl_recibo_contrato.fecha_fin_vigencia,	tbl_recibo_contrato.num_recibo_prima,
	comisionados.nombres, comisionados.apellidos,tbl_recibo_contrato.id_recibo_contrato,tbl_contrato_anulado.fecha_creado,tbl_contrato_anulado.id_admin  
...
/*
$q_cuota=("select tbl_recibo_pago.saldo_deudor, tbl_recibo_pago.fecha_proxima_pago from tbl_recibo_pago where tbl_recibo_pago.id_recibo_contrato=$f_venta[id_recibo_contrato] and tbl_recibo_pago.estado_recibo=0 order by tbl_recibo_pago.id_recibo_pago DESC limit 1");
...
echo  " 
		...
		<td class=\"tdcamposr\">$f_venta[a] $f_venta[b]</td>
		<td class=\"tdcamposr\">$f_venta[nombre_articulo] </td>
		<td class=\"tdcamposr\">$f_venta[fecha_creado] </td>
"; 
...
<table>
	...
	<tr>
	        <td colspan=4 class="tdcamposs" title="Imprimir reporte">
			  <?php
			 $url="'views06/excel_contrato_anulado.php?fecha1=$fecre1&fecha2=$fecre2'";
