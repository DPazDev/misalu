...
<br>
 <table class="tabla_citas"  cellpadding=0 cellspacing=0> 
	...
	<img src="../public/images/calendar.gif" class="cp_img" alt="Seleccione la Fecha"></a>
     ...
     <tr> 
	    <td colspan=2 class="tdtitulos">* C&oacute;digo del médicamento:</td>
         <td class="tdcampos"><input type="text" id="codartic" class="campos" size="28"></td>     
	...
	<br>
     <tr> 
       <br>
         <td class="tdcampos" title="Generar reporte"><label class="boton" style="cursor:pointer" onclick="Reporestadis()" >Procesar</label></td> 	
     </tr>              
 </table>
