...
(clinicas_proveedores.id_clinica_proveedor=238 or clinicas_proveedores.id_clinica_proveedor=291) order by clinicas_proveedores.nombre;");
$repfarmacia=ejecutar($farmacias);
$servicio=("select servicios.id_servicio,servicios.servicio from servicios where servicios.id_servicio=5 or servicios.id_servicio=7 order by servicio;");
...
(estados_procesos.id_estado_proceso=7 or estados_procesos.id_estado_proceso=4 or estados_procesos.id_estado_proceso=2) order by estados_procesos.estado_proceso;");
$repestadospro=ejecutar($estadospro);
?>
<br>
<table class="tabla_cabecera3"  cellpadding=0 cellspacing=0>
     <tr>
         <td colspan=4 class="titulo_seccion">Frecuencia de uso (Oredenes de m&eacute;dicamentos externo)</td>
     </tr>
</table>
<br>
 <table class="tabla_citas"  cellpadding=0 cellspacing=0> 
	...
	<br>
     ...
     <tr> 
         <td class="tdcampos" title="Generar reporte"><label class="boton" style="cursor:pointer" onclick="Usoestadis()" >Procesar</label></td>
        <td class="tdcampos" title="Imprimir reporte"><label class="boton" style="cursor:pointer" onclick="Usoestadis1()" >Imprimir</label></td> 	  	
     </tr>              
 </table>
