...
<table class="tabla_cabecera3"  cellpadding=0 cellspacing=0>
     <tr> 	 
         <td colspan=4 class="titulo_seccion">Control de art&iacute;culos despachado y usado por dependencia</td>  
     </tr>
</table>	
	...
	echo"</tr>
	 ...
	 <br>     
	   <tr>
	     ...
	     <td  title="Generear reporte de control de art&iacute;culos"><label class="boton" style="cursor:pointer" onclick="ReporteUsoArti(); return false;" >Generar Reporte</label></td>   
	  </tr>   
</table>
