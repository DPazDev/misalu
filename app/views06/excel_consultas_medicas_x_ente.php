<?php
/* Nombre del Archivo: excel_consultas_medicas_x_ente.php
   Descripción: Realiza la busqueda en la base de datos, para el Reporte en Excel: Consultas Médicas Por Entes (Totales por Entes y por Especialidad)
*/  
