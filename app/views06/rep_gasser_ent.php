...
<tr>		<td colspan=4 class="titulo_seccion">Reporte que Funciona Totalizando las Ordenes de un Servicio y Muestra los Gastos por Servicios (la opcion de proveedores directo o indirecto funciona con todos porque hay que actualizar proveedores para identificarlos )</td>	</tr>	

<td colspan=4 class="titulo_seccion">Reporte de Gastos Generales por Entes  </td>	</tr>	
<tr> 
...
<img src="../public/images/calendar.gif" class="cp_img" alt="Seleccione la Fecha"></a>
	...
	<tr> 
	  ...
	  <td class="tdtitulos" colspan="1">Seleccione Tipo de Ente:</td>
		 <td class="tdcampos"  colspan="1">
         <select class="campos"  style="width: 200px;"  id="tipo_ente" name="tipo_ente" onchange="bus_ent(2)" >
