...
<tr>
		<td class="titulo_seccion" colspan="7"> No existe un Cliente con el N&uacute;mero de C&eacute;dula <?php echo"$ci"; ?></td>     
	</tr>
</table><?php }
else {
...
<tr> 
	...
	<tr>
	<tr> 
		<td class="tdtituloss">Nombre y Apellido del Titular:&nbsp;&nbsp;&nbsp; <?php echo "$f_tit_ben[nombres] $f_tit_ben[apellidos]";?></td>
	</tr>
...
?>
	...
	<tr>
	        <td colspan=7 class="tdtitulos" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Hay un total de <?php echo $i-1; ?> Consultas Preventivas  </td>
