...
where tbl_procesos_claves.id_proceso=procesos.id_proceso and
tbl_procesos_claves.id_factura=$f_factura[id_factura] and procesos.id_titular=titulares.id_titular and
gastos_t_b.id_proceso=procesos.id_proceso and gastos_t_b.monto_aceptado>='0' and (gastos_t_b.id_tipo_servicio<>27 and gastos_t_b.id_tipo_servicio<>28)
;");
		 ...
		 if ($f_cliente[id_recibo_contrato]>0)
	{
		...
		else
		{
			while($f_gasto=asignar_a($r_gasto)){
				...
				?>
			<tr>
		<td width="50%" align="left" style="font-size: 07pt"><?php echo "$f_gasto[nombre] ($f_gasto[descripcion] )";  ?></td>
			<td width="5%" align="left"></td>

			<td width="10%" align="right" style="font-size: 07pt"><?php echo montos_print($f_gasto[monto_aceptado])?></td>
		</tr>
	<?php
	}
	}
...
?>
	...
	<tr>
				<td  valign="top" align="right" style="font-size: 07pt">MONTO TOTAL EXENTO O EXONERADO Bs.S. </td>
	...
	<tr>
				<td  valign="top" align="right" style="font-size: 07pt">Base imponible segun alicuota_% Bs.S.</td>
	...
	<tr>
				...
				<td  valign="top" align="right" style="font-size: 07pt">Monto Total del impuesto segun alicuota_% Bs.S</td>

    			<td  valign="top" align="right"> </td>
	</tr>
	<tr>

				<td  valign="top" align="right" style="font-size: 07pt">Monto Total del IVA (<?php echo $PorIVA;?>)% Bs.S</td>

    			<td  valign="top" align="right"><?php echo montos_print($totalIva);?></td>
	</tr>
 ...
 <?php
        ...
        ?>
			...
			<tr>
				...
				<td  valign="top" align="right" style="font-size: 07pt">MONTO NO APROBADO Bs.S.</td>
...
<tr>
				<td  valign="top" align="right" style="font-size: 07pt">MONTO TOTAL DE LA VENTA</td>
					...
					<td width="130" valign="top" align="right" style="font-size: 07pt">  <?php  echo montos_print(abs($total - $f_deducible[sum] - $elmontonoaprobado + $totalIva));  ?> </td>
	</tr>
...
<?php
 ...
 //fin del calculo IGTF
				...
				<tr>
				<td  valign="top" align="right" style="font-size: 07pt">MONTO TOTAL A PAGAR BsS </td>


				<td width="130" valign="top" align="right" style="font-size: 07pt"> <?php  echo montos_print(abs($total - $f_deducible[sum] - $elmontonoaprobado + $montoigtf + $totalIva));  ?></td>
			</tr>
	...
	<tr>
				<td  valign="top" align="right" style="font-size: 07pt">MONTO TOTAL DE LA VENTA</td>
					...
					<td width="130" valign="top" align="right" style="font-size: 07pt"> <?php echo montos_print($total+$totalIva); echo  $cero;?></td>
	</tr>
	<tr>
...
<?php
 ...
 //fin del calculo IGTF
				...
				<tr>
				<td  valign="top" align="right" style="font-size: 07pt">MONTO TOTAL A PAGAR
    		</td>


				<td width="130" valign="top" align="right" style="font-size: 07pt"> <?php echo montos_print(abs($total + $montoigtf + $totalIva));  echo  $cero;?></td>
			</tr>
