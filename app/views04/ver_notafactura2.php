...
$q_factura="select
					...
					where
							...
							tbl_nota_factura.tipo_nota='$TipoNota' and
...
?>
	...
	<tr>
		<td colspan=4  class="titulo_seccion"> Formatos de la Factura
			<?php $url="'views04/inotafactura.php?id_factura=$f_factura[id_factura]&num_nota=$NumNota','700','500'";?>
			<a href="javascript: imprimir(<?php echo $url; ?>);" class="boton" title="Imprimir Notas de Creditos"> Imprimir Nota Credito <?php echo "$num_nota" ?></a>
			<?php $url="'views04/inotacreditogob.php?id_factura=$f_factura[id_factura]&num_nota=$NumNota','700','500'";?>
			<a href="javascript: imprimir(<?php echo $url; ?>);" class="boton" title="Imprimir Notas de Creditos"> Imprimir Nota Credito Plan Salud<?php echo "$num_nota" ?></a>
		</td>
	</tr>
	<tr>
		<td colspan=4  class="titulo_seccion">Datos Facturas</td>
	</tr>
<tr>
<td  class="tdtitulos">No. de Nota Credito</td>
<td  class="tdcampos"><input type="hidden" id="id_nota_factura" name="id_nota_factura" value="<?php echo $f_factura[id_nota_factura]; ?>"><?php echo $f_factura[num_nota]; ?></td>
<td  class="tdtitulos">No. de Control Nota Credito</td>
<td  class="tdcampos"><input class="campos" size="10" type="text" id="controlfactura" name="controlfactura" value="<?php echo $f_factura[numcontrolnota]; ?>"></td>
<tr>
<tr>
