...
<?php
  if(($serie == '1') || ($serie == '2') || ($serie == '3') || ($serie == '5') || ($serie == '7') || ($serie == '8') ){
?>
<br><br>
<br><br>
<br><br>
...
<table width="100%" cellspacing=0 cellpadding=0 border=0>
	<tr>
		<td width="70%">&nbsp;</td>
		<td width="30%" style="padding-top: 15px;height: 30px;text-align: right;" valign="top"><b>Relacion de Gastos de la Factura Numero 00<?php echo $no_factura; ?></b></td>
	</tr>
</table>
<br><br>
<table width="100%" cellspacing=0 cellpadding=0 border=0>
...
<tr>
	         <td width="80%" align="left">Cliente: <?php echo $f_cliente[nombre];?>
			</tr>
		 <tr>
		 <td align="left">RIF: <?php echo $f_cliente[rif]; ?></td>
	 </tr>
...
<tr>
     ...
     <table width="100%" cellspacing=0 cellpadding=0 border=0>
	<tr>
		<td width="80%" align="left">Titular: <?php echo $f_cliente[nombres]; echo $f_cliente[apellidos];?></td>
		<td>&nbsp;</td>
...
<table width="100%" cellspacing=0 cellpadding=0 border=0>
	<tr>
			<td  align="right">Condicion Pago:<?php 
				...
				else if($f_factura['condicion_pago']==3 || $f_factura['condicion_pago']==4 || $f_factura['condicion_pago']==5 || $f_factura['condicion_pago']==6 )
					echo "Contado";
		?>
		</td>
		</tr>
...
<table width="100%" cellspacing=0 cellpadding=0 border=0 style="border: thin solid black;">
	<tr>
	<td colspan=2 width="90%" align="left">Concepto o Descripcion</td>
    	
	<td width="10%" align="right">Total Bs.S.</td>
	</tr>
	<?php
	 $total=0;
			...
			while($f_gasto=asignar_a($r_gasto)){
                ...
                ?>
            <tr>
		<td colspan=2 width="90%" align="left"><?php echo "$f_gasto[tipo_servicio]";  ?></td>
...
tbl_procesos_claves.id_factura=$f_factura[id_factura]  and gastos_t_b.id_tipo_servicio=$f_gasto[id_tipo_servicio]
 and gastos_t_b.monto_aceptado>'0';");
            ...
            while($f_gasto1=asignar_a($r_gasto1)){
                  ...
                  if ($f_gasto[id_tipo_servicio]>=14 || $f_gasto[id_tipo_servicio]<=17)
                {
                ...
                $r_p=ejecutar($q_p);
                $f_p=asignar_a($r_p);
                $proveedor="$f_p[nombres_prov] $f_p[apellidos_prov]";
                  }   
			...
			<tr>
            <td width="10%" align="left"></td>
			<td width="80%" align="left"><?php if ($f_gasto[id_tipo_servicio]==22 || $f_gasto[id_tipo_servicio]==23 ) {
                echo " $f_gasto1[nombre]";  
                }
                else
                {
                       echo "$proveedor  $f_gasto1[descripcion]";  
                    }?></td>
			</td>
			<td width="10%" align="right"><?php echo montos_print($f_gasto1[monto_aceptado]);?></td>
		</tr>
	<?php
    }
	}
...
?>		
 ...
 <?php
        ...
        ?>
				...
				<tr>
				<td  valign="top" align="right">MONTO DEDUCIBLE Bs.S.
    		</td>
			
			
				<td width="200" valign="top" align="right"><?php echo montos_print($f_deducible[sum]);  ?> </td>
			</tr>
			</tr>
				<tr>
				...
				<td width="200" valign="top" align="right"> <?php echo montos_print($total-$f_deducible[sum]);  ?></td>
			</tr>
...
<table width="100%" cellspacing=0 cellpadding=0 border=0>
	<tr>
		<td width="70%">&nbsp;</td>
		<td width="30%" style="padding-top: 05px;height: 30px;text-align: right; font-size: 08pt;" valign="top"><b>Relacion de Gastos de la Factura Numero 00<?php echo $no_factura; ?></b></td>
	</tr>
</table>
<br><br>
<table width="100%" cellspacing=0 cellpadding=0 border=0>
...
<tr>
     ...
     <table width="100%" cellspacing=0 cellpadding=0 border=0>
	<tr>
		<td width="80%" align="left" style="font-size: 08pt">Titular: <?php echo $f_cliente[nombres]; echo $f_cliente[apellidos];?></td>
		<td>&nbsp;</td>
...
<table width="100%" cellspacing=0 cellpadding=0 border=0>
	<tr>
			<td  align="right" style="font-size: 08pt">Condicion Pago:<?php 
				if($f_factura['condicion_pago']==1)
					echo "Contado";
				else if($f_factura['condicion_pago']==2)
					echo "Cr&eacute;dito $fecha_credito";	
...
<table width="100%" cellspacing=0 cellpadding=0 border=0 style="border: thin solid black;">
	<tr>
	<td colspan=2 width="90%" align="left" style="font-size: 08pt">Concepto o Descripcion</td>
	...
	<?php
	 $total=0;
			...
			while($f_gasto=asignar_a($r_gasto)){
                ...
                ?>
            <tr>
		<td colspan=2 width="90%" align="left" style="font-size: 08pt"><?php echo "$f_gasto[tipo_servicio]";  ?></td>
		 <td width="10%" align="left"></td>
...
tbl_procesos_claves.id_factura=$f_factura[id_factura]  and gastos_t_b.id_tipo_servicio=$f_gasto[id_tipo_servicio]
 and gastos_t_b.monto_aceptado>'0';");
			...
			<tr>
            <td width="10%" align="left"></td>
			<td width="80%" align="left" style="font-size: 08pt"><?php if ($f_gasto[id_tipo_servicio]==22 || $f_gasto[id_tipo_servicio]==23 ) {
                echo " $f_gasto1[nombre]";  
                }
                else
                {
			...
			<td width="10%" align="right" style="font-size: 08pt"><?php echo montos_print($f_gasto1[monto_aceptado]);?></td>
		</tr>
	<?php
    }
	}
...
?>		
	...
	<tr>
				<td  valign="top" align="right" style="font-size: 08pt">MONTO TOTAL EXENTO O EXONERADO Bs.S. 
    		</td>
			
			
				<td width="200" valign="top" align="right" style="font-size: 08pt"> <?php echo montos_print($total); echo  $cero;?></td>
			</tr>
				<tr>
				<td  valign="top" align="right" style="font-size: 08pt">Base imponible segun alicuota_% Bs.S. 
    		</td>
				...
				<tr>
				<td  valign="top" align="right" style="font-size: 08pt">Monto Total del impuesto segun alicuota_% Bs.S. 
    		</td>
			
			
				<td width="200" valign="top" align="right" style="font-size: 08pt"> </td>
			</tr>
 ...
 <?php
        ...
        ?>
				...
				<tr>
				<td  valign="top" align="right" style="font-size: 08pt">MONTO DEDUCIBLE Bs.S.
    		</td>
			
			
				<td width="200" valign="top" align="right" style="font-size: 08pt"><?php echo montos_print($f_deducible[sum]);  ?> </td>
			</tr>
			</tr>
				<tr>
				<td  valign="top" align="right" style="font-size: 08pt">MONTO TOTAL DE LA VENTA Bs.S.
    		</td>
			
			
				<td width="200" valign="top" align="right" style="font-size: 08pt"> <?php echo montos_print($total-$f_deducible[sum]);  ?></td>
			</tr>
