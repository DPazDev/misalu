...
?>		
	...
	<tr>
				<td  valign="top" align="right">MONTO TOTAL EXENTO O EXONERADO Bs. 
    		</td>
...
<?php //Apartir de esta linea es MEDIA CARTA
  if( ($serie == 32)  ){ ?>		
...
<table width="100%" cellspacing=0 cellpadding=0 border=0>
	<tr>
		<td width="70%">&nbsp;</td>
		<td width="30%" style="padding-top: 01px;height: 30px;text-align: right; font-size: 08pt;" valign="top"><b> Nota de Credito 00<?php echo $num_notacredito; ?> Afecta la factura 00<?php echo $f_factura[numero_factura]; ?> Serie <?php echo $f_factura[nomenclatura]; ?></b></td>
	</tr>
...
<table width="100%" cellspacing=0 cellpadding=0 border=0>
	<tr>
		<td width="80%" align="left" style="font-size: 08pt">Nombre o razon social: <?php echo $f_cliente[nombres]; echo $f_cliente[apellidos];?></td>
		<td>&nbsp;</td>
...
<table width="100%" cellspacing=0 cellpadding=0 border=0 style="border: thin solid black;">
	...
	<td width="10%" align="left"></td>
	<td width="20%" align="right" style="font-size: 08pt">Total Bs.S.</td>
	</tr>
	<?php
	 $total=0;
	...
	if  ($f_factura[concepto]<>"") {
		...
		while($f_gasto=asignar_a($r_gasto)){
				...
				?>
			<tr>
		<td width="70%" align="left" style="font-size: 08pt"><?php echo "$f_factura[concepto]";  ?></td>
			<td width="10%" align="left"></td>
			
			<td width="20%" align="right" style="font-size: 08pt"><?php echo montos_print($total);?></td>
		</tr>
		<?php
		...
		else
		{
			while($f_gasto=asignar_a($r_gasto)){
				...
				?>
			<tr>
		<td width="70%" align="left" style="font-size: 08pt"><?php echo "$f_gasto[nombre] ($f_gasto[descripcion] )";  ?></td>
			<td width="10%" align="left"></td>
			
			<td width="20%" align="right" style="font-size: 08pt"><?php echo montos_print($f_gasto[monto_aceptado]);?></td>
		</tr>
	<?php
	}
	}
...
?>		
	...
	<tr>
				...
				<td width="200" valign="top" align="right" style="font-size: 08pt"> <?php echo montos_print($total * -1);  echo  $cero;?></td>
			</tr>
			
		</table>		
		<table width="100%" cellspacing=0 cellpadding=0 border=0>
			<tr>
				<td rowspan=2 valign="top" align="left" style="font-size: 08pt">Son: <?php 
...
logs($log,$ip,$id_admin);
 ?>
  ...
  <?php }?>
  <?php 
 //Apartir de esta linea es MEDIA CARTA

  if( ($serie == '9')  || ($serie == '3') || ($serie == '1') || ($serie == '5') || ($serie == 6) || ($serie == '8') || ($serie == '4')){ 
  ?>
  <br> 
    <table width="70%" cellspacing=0 cellpadding=0 border=0>
	<tr>
		<td width="70%">&nbsp;</td>
		<td width="70%" style="padding-top: 21px;height: 30px;text-align: right; font-size: 08pt; font-size: 07pt;" valign="top"><b> Nota de Credito 00<?php echo $num_notacredito; ?> Afecta la factura 00<?php echo $f_factura[numero_factura]; ?> Serie <?php echo $f_factura[nomenclatura]; ?></b></td>
	</tr>
...
<br><br>
<table width="70%" cellspacing=0 cellpadding=0 border=0 style="border: thin solid black;">
	<tr>
	<td width="70%" align="left" style="font-size: 08pt">Concepto o Descripcion</td>
	<td width="10%" align="left"></td>
	<td width="20%" align="right" style="font-size: 08pt">Total Bs.S.</td>
