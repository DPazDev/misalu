...
<tr>		<td colspan=4 class="titulo_seccion">Registrar Recibos de Pagos de Cuadro de Primas</td>	</tr>	
	<tr>
...
<td colspan=1 class="tdcampos">
		...
		<td colspan=1 class="tdtitulos"></td>
<td colspan=1 class="tdcampos">
	<a href="#" OnClick="bus_reg_rec_pago();" title="buscar el contrato del usuario y sus cuadro recibo de prima "class="boton">Buscar</a><a href="#" OnClick="ir_principal();" class="boton">Salir</a>
	
	</td>
		</tr>
		
</table>
<div id="bus_regrec_pago"></div>
