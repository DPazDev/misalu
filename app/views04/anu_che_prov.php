...
$mod_pro="update 
                    ...
                    from 
                            facturas_procesos 
                    where 
                            procesos.id_proceso=facturas_procesos.id_proceso and 
                            facturas_procesos.numero_cheque='$numerocheque' and
                            facturas_proceso.id_banco='$id_banco'";
...
$mod_fpro="update 
                    ...
                    set
                            id_banco=9,
                            id_banco_anulado=$id_banco,
                            motivo='$motivo',
                            compro_retiva_seniat='0',
                            corre_retiva_seniat=0,
                            corre_compr_islr='0',
                            corre_ret_islr=0 
...
$log="Se Anulo el Cheque  con el  numero $numerocheque id_banco $id_banco motivo $motivo ";
logs($log,$ip,$admin);
