...
if  ($controlfactura==0 || ($controlfactura<=$ult_controlfactura)){
	...
	<tr><td colspan=4  class="titulo_seccion"><?php echo "EL NUMERO DE CONTROL NO PUEDE SER VACIO o MENOR  o IGUAL AL ANTERIOR"; ?></td> 
	</tr>   
...
//MODIFICACION ING PATRICIA 29-9-22
...
<table class="tabla_cabecera3"  cellpadding=0 cellspacing=0>
  ...
  <input readonly type="hidden" id="cedula_p_pago" name="nombre_p_pago" maxlength="20" class="campos" size=20 >
   ...
   //*************************************************************************************** CREDITO
    ...
    <div>	
    <label  class="tdtitulos">*  Fecha de Final de Credito  </label>
    </div>
    <div><input readonly type="text" size="10" id="dateField5" name="fechac" class="campos" maxlength="10" value="" required> 
...
<?php }
   ...
   if ($forma_pago==5){
                ...
                $q_forma_pago="select * from tbl_nombre_tarjetas where tbl_nombre_tarjetas.id_tipo_pago=$forma_pago 	";
...
if (($forma_pago==7 || $forma_pago==10)) {
   ...
   <div id="div_forma_pago2" style="display: none;">
     <fieldset class="tipos-pagos1">
      ...
      <!----------------------------------------------------------------------------------------------------------->
       <div>
	 		<label class="tdtitulos">Forma de pago</label>
    ...
    <!----------------------------------------------------------------------------------------------------------->
			...
			?>
	     <div>
		   <div class="tdtitulos" id="servicio-descripcion2" ></div>
   ...
   <!----------------------------------------------------------------------------------------------------------->
            ...
            <div>
			<label class="tdtitulos"  id="servicio-referencia2" >Referencia</label>
...
<!----------------------------------------------------------------------------------------------------------->
       ...
       <div>
			 <div><label class="tdtitulos" id="servicio-tipomoneda2" >Moneda</label></div>
			 <?php
                //busco los tipos de monedas
                $q_tipo_moneda="select * from tbl_monedas order by tbl_monedas.id_moneda";
                $r_tipo_moneda=ejecutar($q_tipo_moneda);
...
<!----------------------------------------------------------------------------------------------------------->
       ...
       <div>
       <label class="tdtitulos" id="servicio-monto2" type="hidden">Monto</label>
...
<!----------------------------------------------------------------------------------------------------------->
   ...
   <div id="div_forma_pago3" style="display: none;">
    ...
    <!----------------------------------------------------------------------------------------------------------->
			...
			?>
	     <div>
		   <div class="tdtitulos" id="servicio-descripcion3" ></div>
   ...
   <!----------------------------------------------------------------------------------------------------------->
            ...
            <div>
			<label class="tdtitulos"  id="servicio-referencia3" >Referencia</label>
...
<!----------------------------------------------------------------------------------------------------------->
       ...
       <div>
			 <div><label class="tdtitulos" id="servicio-tipomoneda3" >Moneda</label></div>
			 <?php
                //busco los tipos de monedas
                $q_tipo_moneda="select * from tbl_monedas order by tbl_monedas.id_moneda";
                $r_tipo_moneda=ejecutar($q_tipo_moneda);
...
<!----------------------------------------------------------------------------------------------------------->
         ...
         <div>
         <label class="tdtitulos" id="servicio-monto3" type="hidden">Monto</label>
...
<!----------------------------------------------------------------------------------------------------------->
   ...
   <div id="div_forma_pago4" style="display: none;">
    ...
    <!----------------------------------------------------------------------------------------------------------->
			...
			?>
	     <div>
		   <div class="tdtitulos" id="servicio-descripcion4" ></div>
   ...
   <!----------------------------------------------------------------------------------------------------------->
            ...
            <div>
			<label class="tdtitulos"  id="servicio-referencia4" >Referencia</label>
...
<!----------------------------------------------------------------------------------------------------------->
       ...
       <div>
			 <div><label class="tdtitulos" id="servicio-tipomoneda4" >Moneda</label></div>
			 <?php
                //busco los tipos de monedas
                $q_tipo_moneda="select * from tbl_monedas order by tbl_monedas.id_moneda";
                $r_tipo_moneda=ejecutar($q_tipo_moneda);
...
<!----------------------------------------------------------------------------------------------------------->
         ...
         <div>
         <label class="tdtitulos" id="servicio-monto4" type="hidden">Monto</label>
...
<!----------------------------------------------------------------------------------------------------------->
	...
	<input type="text" id="calculo" name="calculo" class="campos" size=10 maxlength="10" value="0"></td>
    </div>
    </fieldset>
   ...
   <fieldset class="tipos-pagos2">
    <div><label class="tdtitulos">Concepto</label></div>
	  <textarea id="concepto" name="concepto" cols=70 rows=2 class="campos"></textarea>
   </fieldset>
...
<td class="tdtitulos"></td>
<td class="tdtitulos"></td>
<td class="tdcampos"><span class="button" type="hidden" name="vacio" maxlength=128 size=20 value="" OnClick="guardar_factura();" >Guardar</span>
</tr>
<?php 
}
else
...
<td class="tdcampos">
	<input readonly type="hidden" size="10" id="dateField5" name="fechac" class="campos" maxlength="10" value=""> 
	<span class="button" type="hidden" name="vacio" maxlength=128 size=20 value="" OnClick="guardar_factura2();" style="visibility:hidden" id="guardar" name="guardar">Guardar</span>
</tr>
<?php
}
}
...
<td class="tdtitulos"></td>
<td class="tdtitulos"></td>
<td class="tdcampos"><input class="campos" type="hidden" name="vacio" maxlength=128 size=20 value=""><a href="#" OnClick="guardar_recibo_pago();" class="boton">Guardar</a></td>
</tr>
<?php 


// Pagos para recibos de pago
} else {
	?>
	<tr>
		<td class="tdtitulos"></td>
		...
		<td class="tdtitulos"></td>
		<td class="tdcampos">
			<input type="hidden" size="10" id="dateField5" name="fechac" class="campos" maxlength="10" value="">
			<span class="button" type="hidde" name="vacio" maxlength=128 size="20" value="" onClick="guardar_recibo_pago2();" style="visibility:hidden" id="guardar" name="guardar">Guardar</span>
		</td>
	</tr>
	<?php
}
...
<td class="tdtitulos"></td>
<td class="tdtitulos"></td>
<td class="tdcampos"><input class="campos" type="hidden" name="vacio" maxlength=128 size=20 value=""><a href="#" OnClick="guardar_facturagob();" class="boton">Guardargob</a></td>
</tr>
<?php 
}
else
...
<input class="campos" type="hidden" name="vacio" maxlength=128 size=20 value=""><a href="#" OnClick="guardar_facturagob2();" style="visibility:hidden" id="guardar" name="guardar" class="boton">Guardargob2</a></td>
</tr>
<?php
}
}
...
?>
<table class="tabla_cabecera3"  cellpadding=0 cellspacing=0>
	<tr><td colspan=4  class="titulo_seccion"><?php 
echo "NUMERO DE CONTROL ESTA ASIGNADO A LA SIGUIENTE FACTURA $f_control[numero_factura] SERIE $f_control[nomenclatura]"; ?></td> 
	</tr>   
