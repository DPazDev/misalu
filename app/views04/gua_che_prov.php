...
$idordcom2=split("@",$idordcom1);
$iva_fact2=split("@",$iva_fact1);
$montoexento2=split("@",$montoexento1);
$baseimponible2=split("@",$baseimponible1);
$iva_ret2=split("@",$iva_ret1);

$confactura2=split("@",$confactura1);
...
$q_act="select clinicas_proveedores.id_act_pro from clinicas_proveedores,proveedores  
