...
<table width="100%" cellspacing=0 cellpadding=0 border=0 style="border: thin solid black;">
	...
	<?php
		...
		<td width="70%" align="left"><?php echo $ladescripcionmono;  ?></td>
			<td width="10%" align="left"></td>
...
<?php 
 //Apartir de esta linea es MEDIA CARTA vertival
  if( ($serie == '9')  || ($serie == '3') || ($serie == '1') || ($serie == '5') || ($serie == '6') || ($serie == '4')){ 
?>
 <br> 

<table width="70%" cellspacing=0 cellpadding=0 border=0><tr>

		<td width="70%" valign="top"></td>
		<td width="70%" style="padding-top: 21px;height: 30px;text-align: right; font-size: 07pt;" valign="top"><b>CONTRIBUYENTE FORMAL</b></td>
	</tr>

	<tr>
		<td width="70%" valign="top"></td>
		<td width="30%" style="padding-top: 01px;height: 30px;text-align: right; font-size: 08pt;" valign="top"><b>Serie <?php echo $f_factura['nomenclatura']; ?></b> <b>No. de factura 00<?php echo $no_factura; ?></b></td>
	</tr>
		<tr>
		<td width="70%" valign="top"><b> <?php if ($f_factura[codigosap]>0){ echo "Codigo Sap $f_factura[codigosap]";} ?> </b></td>
		<td width="30%" style="padding-top: 15px;height: 30px;text-align: right; font-size: 08pt;" valign="top"> </td>
