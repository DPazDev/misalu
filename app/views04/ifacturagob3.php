...
$q_cliente=("select  clientes.id_ciudad as ciudadcliente,clientes.*,titulares.*,entes.*,tbl_procesos_claves.*,procesos.* ,tbl_partidas.*
from clientes,titulares,entes,tbl_procesos_claves,procesos,tbl_partidas
...
titulares.id_ente=entes.id_ente and titulares.id_cliente=clientes.id_cliente and titulares.tipo_partida=tbl_partidas.id_partida
;");
...
<table width="100%" cellspacing=0 cellpadding=0 border=0>
	...
	<table width="100%" cellspacing=0 cellpadding=0 border=0>
        <tr>
	         <td width="80%" align="left">Nombres o razon social: <?php echo $f_cliente[nombre];?>
			</tr>
...
<table width="100%" cellspacing=0 cellpadding=0 border=0>
 ...
 <tr>
	         <td width="80%" align="left">Nombre o razon social: GOBERNACION DEL ESTADO MERIDA - PLAN DE SALUD
			</tr>
		 <tr>
...
<tr>
   		<td width="80%" align="left">Telefono: 02742525072</td>
...
tbl_procesos_claves.id_factura=$f_factura[id_factura]  and gastos_t_b.id_tipo_servicio=$f_gasto[id_tipo_servicio]
 and gastos_t_b.monto_aceptado>'0';");
		...
		$total= ($total + $f_gasto1[monto_aceptado]);
			...
			<tr>
            		<td width="10%" align="left"></td>
			<td width="80%" align="left"><?php echo "$proveedor";?></td>
...
<?php
			...
			<td width="10%" align="right"><?php echo montos_print($monto);?></td>
		</tr>
		<?php
		}
		}
