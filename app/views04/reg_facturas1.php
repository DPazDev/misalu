...
if (!empty($cua_rec_prim))
{
        $f_bus = asignar_a($r_procesos); // == xd 1
        $q_bus_caract= "select
                                sum(monto_bs)
                        from
                                tbl_recibo_pago
	...
	<tr>
		...
		<td class="tdtitulos"></td>
		<td class="tdcampos"></td>
		<td colspan=1 class="tdtitulos">Total Pagado BS.</td>
                <td colspan=1 class="tdcampos">
	...
	while($f_busc=asignar_a($r_busc,NULL,PGSQL_ASSOC))
        {
                ...
                <tr>
                        <td class="tdtitulos"></td>
                        <td class="tdcampos"></td>
                        <td colspan=1 class="tdtitulos">Deuda USD.</td>
	...
	if(num_filas($r_facturado)==0 and ((number_format($f_buscon_caract[sum] - $f_buscon_pagos[sum]  ,2,',',''))<=0))
        {
                ?>
                <tr>
                        <td colspan=4  class="titulo_seccion">Ingresar Datos de la Factura</td>
                </tr>
                <tr>
                        ...
                        <td class="tdcampos">
                                <input type="hidden" id="serie" name="serie" value="<?php echo $f_series[id_serie]; ?>"><?php echo $f_series[nomenclatura]; ?>
                        </td>
                </tr>
                <tr>
                        <td  class="tdcamposr">Ultimo No. de Control Factura</td>
                        <td  class="tdcamposr">
                                <input type="hidden" id="ult_controlfactura" name="ult_controlfactura" value="<?php echo $num_control ?>"><?php echo  $num_control;?>
                        </td>
                ...
                <tr>
                        ...
                        <td  class="tdcampos">
                                <input class="campos" type="text" id="controlfactura" OnChange="verificar_numcontrol();" name="controlfactura" value="">
                        </td>
                ...
                <tr>
                        ...
                        <td colspan=3 class="tdcampos">
                                ...
                                <a href="#" OnClick="guar_fact_rec_pri();" id="guardar" name="guardar" class="boton">Guardar</a>
                        </td>
                </tr>
                </tr>
                <?php
        ...
        else
        {
                if ((number_format($f_buscon_caract[sum] - $f_buscon_pagos[sum]  ,2,',',''))>0){
                        ...
                        <tr>
                                <td colspan=4  class="titulo_seccion">El Cuadro Recibo de Prima Tiene Deuda Pendiente no Puede Ser Facturado</td>
                        </tr>
                        <?php
                }
                else
                {
                        ...
                        <tr>
                                <td colspan=4  class="titulo_seccion">Recibo de Prima Facturado</td>
                        </tr>
                        <tr>
                                <td colspan=4 height=20 class="titulos"><hr></td>
                        </tr>
                        ...
                        while($f_facturado=asignar_a($r_facturado)){
                                ...
                                <tr>
                                        ...
                                        <td colspan=1 height=20 class="tdcampos">
                                                <?php echo $f_facturado[numero_factura]?>
                                        </td>
                                        <td colspan=1 height=20 class="tdcampos">
                                                <?php echo $f_facturado[nomenclatura]?>
                                        </td>
                                        <td colspan=1 height=20 class="tdcampos">
                                                <?php echo $f_facturado[fecha_emision]?>
                                        </td>
                                </tr>
                                <?php
                        }
