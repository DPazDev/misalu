...
$mod_fpro="update facturas_procesos set id_banco=9,id_banco_anulado=$f_facturas_procesos[id_banco],motivo='$motivo' where  facturas_procesos.codigo='$codigo'";
$fmod_fpro=ejecutar($mod_fpro);

/* **** Se registra lo que hizo el usuario**** */
$log="Se Anulo el Cheque  con el  codigo numero $codigo motivo $motivo y motivo anterior $f_facturas_procesos[motivo]";
logs($log,$ip,$admin);
