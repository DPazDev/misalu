...
while($f_facturas=asignar_a($r_facturas,NULL,PGSQL_ASSOC)){
	...
	<?php 
	$alicuotacal= $f_facturas[iva]*100/$f_facturas[monto_con_retencion];
	$alicuota=round( $alicuotacal, 0, PHP_ROUND_HALF_DOWN);
	
	$totalalicuota=$total_iva_fac*100/$baseimponible;	
	$totalalicuota=round($totalalicuota, 0, PHP_ROUND_HALF_DOWN);
	?>
		<?php 
...
?>
	<tr>
		...
		<td colspan=1 class="tdcampos"><?php echo number_format($alicuota,2,',','')?> %</td><!-- ALICUTA -->
...
?>
		...
		<tr>
		<td colspan=1 class="tdtitulos"></td>
		<td colspan=1 class="tdtitulos">TOTALES</td>
		<td colspan=1 class="factura"></td>
		<td colspan=1 class="factura"><?php echo number_format($montototal,2,',','')?></td>
		<td colspan=1 class="factura"><?php echo number_format($monto_exento,2,',','')?></td>
		<td colspan=1 class="factura"><?php echo number_format($baseimponible,2,',','')?></td>
		<td colspan=1 class="factura"><?php echo number_format($totalalicuota,2,',','')?>%</td><!-- ALICUTA -->
		<td colspan=1 class="factura"><?php echo number_format($total_iva_ret,2,',','')?></td>
		<td colspan=1 class="factura"><?php echo number_format($total_neto,2,',','')?></td>
	</tr>
	<tr>
<td colspan=9 class="tdtitulos"><hr></hr></td>
</tr>
