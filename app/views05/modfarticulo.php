...
<table class="tabla_cabecera3"  cellpadding=0 cellspacing=0>
 <tr>  
    <td colspan=8 class="titulo_seccion">Modificar art&iacute;culo</td>  
 </tr>
 <tr>
...
<br>
    <tr> 
         <td class="tdtitulos">Por c&oacute;digo de barra:</td>
         <td class="tdcampos"><input type="text" id="codbarraar" class="campos" size="10"></td>
     ...
     <tr> 
             ...
             <BR>
             <td  title="Buscar art&iacute;culo seg&uacute;n opci&oacute;n"><label class="boton" style="cursor:pointer" onclick="Buscarelarti(); return false;" >Buscar</label></td>
             <td class="tdtitulos"></td>
     </tr>
</table>
