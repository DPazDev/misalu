...
$ladepen=("select tbl_ordenes_pedidos.id_dependencia from tbl_ordenes_pedidos where tbl_ordenes_pedidos.id_orden_pedido=$idpedido;");
$repladepen=ejecutar($ladepen);
$datadepen=assoc_a($repladepen);
$ladepenid=$datadepen['id_dependencia'];
?>
	...
	echo"</tr>";		
	 ...
	 <br>     
	   <tr>
			...
			<input type="hidden" id="eliddepen" value="<?echo $ladepenid;?>"> 
