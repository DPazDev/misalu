...
$nomartic=("select tbl_insumos.insumo,tbl_laboratorios.laboratorio from tbl_insumos,tbl_laboratorios where id_insumo='$eliddart' and tbl_insumos.id_laboratorio=tbl_laboratorios.id_laboratorio;");
...
<table class="tabla_citas"  cellpadding=0 cellspacing=0>
           ...
           ?>
			...
			<tr>
			   <td colspan=6><label style="color: #ff0000"> Nota: Si la orden de bienes tiene alg&uacute;n comentario, cargarlo al finalizar el pedido.</label> </td>  
			</tr>
			<tr>
			...
			<br>
            <tr>
                <td  title="Guardar orden de pedido proveedor"><label class="boton" style="cursor:pointer" onclick="guarocompraprOB(); return false; " >Guardar</label></td>
            </tr>
</table>
