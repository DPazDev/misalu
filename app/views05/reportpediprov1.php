...
$buscarproductos=("select tbl_insumos_ordenes_entregas.id_insumo,
       ...
       tbl_insumos.insumo,tbl_tipos_insumos.id_tipo_insumo
from   
       tbl_insumos_ordenes_entregas,tbl_laboratorios,tbl_insumos,tbl_tipos_insumos,tbl_ordenes_entregas
where
   tbl_ordenes_entregas.id_orden_pedido=$idordenpedido and                              
   tbl_ordenes_entregas.id_orden_entrega=tbl_insumos_ordenes_entregas.id_orden_entrega and
   ...
   tbl_insumos.id_tipo_insumo=tbl_tipos_insumos.id_tipo_insumo order by insumo;");
...
$buscarresponsa=("select tbl_ordenes_pedidos.no_orden_pedido,admin.nombres,
       admin.apellidos,tbl_ordenes_pedidos.hora_pedido,
       tbl_ordenes_pedidos.fecha_pedido,tbl_dependencias.dependencia,tbl_dependencias.id_dependencia
                from
...
$paraquien=$databuscarespon['dependencia'];
$paraquien1=$databuscarespon['id_dependencia'];
...
<table border=0 cellpadding=0 cellspacing=0 width="100%">
	...
	<tr>
		...
		<tr>
            <td width="43%" class="titulos"><b>C&oacute;digo.</b></td> 
	...
	while($f_orden2=asignar_a($repbuscarproductos,NULL,PGSQL_ASSOC)){
          $eltipoinsumo=$f_orden2['id_tipo_insumo'];
           $elinsumo=$f_orden2['id_insumo'];  
           $elcodigoes="$paraquien1-$elinsumo-$eltipoinsumo";
        ?>
	
		<tr>
           <td class="titulos"><?echo $elcodigoes?></td>
			<td class="titulos"><?echo $f_orden2['insumo']?></td>
			<td class="titulos"><?echo$f_orden2['cantidad']?></td>
			<td class="titulos"><?echo$f_orden2['laboratorio']?></td>
		</tr>
	<?
	}
	?>
