...
$elprecio=0;
$nomartic=("select tbl_insumos.insumo,tbl_laboratorios.laboratorio from tbl_insumos,tbl_laboratorios where id_insumo=$elartiid and tbl_insumos.id_laboratorio=tbl_laboratorios.id_laboratorio;");
...
<table class="tabla_citas"  cellpadding=0 cellspacing=0>
			...
			<tr>
			   <td colspan=6><label style="color: #ff0000"> Nota: Si el donativo tiene alg&uacute;n comentario, cargarlo al finalizar el donativo.</label> </td>  
			</tr>
			<tr>
            ...
            <tr>
                ...
                <td  title="Guardar orden de donativo"><label class="boton" style="cursor:pointer" onclick="guardonativo(); return false; " >Guardar</label></td>
            </tr>
</table>
<? 
