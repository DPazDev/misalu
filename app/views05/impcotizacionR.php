...
$elcotizacio=239;
$otrog=0;
$datospricotiza=("select tbl_cliente_cotizacion.id_cliente_cotizacion,tbl_cliente_cotizacion.no_cotizacion,tbl_cliente_cotizacion.nombres as n1,
       tbl_cliente_cotizacion.apellidos as n2,tbl_cliente_cotizacion.rif_cedula,
       tbl_cliente_cotizacion.email,tbl_cliente_cotizacion.celular,
       admin.nombres,admin.apellidos,sucursales.sucursal,tbl_cliente_cotizacion.inicial,tbl_cliente_cotizacion.cuotas,
      tbl_cliente_cotizacion.edad
from
       tbl_cliente_cotizacion,admin,sucursales
where
       tbl_cliente_cotizacion.id_cliente_cotizacion=$elcotizacio and
       tbl_cliente_cotizacion.id_admin=admin.id_admin and
...
$datocargafami=("select tbl_caract_cotizacion.cantidad,tbl_caract_cotizacion.montoprima,
                                 tbl_caract_cotizacion.sexo,primas.edad_inicio ,primas.edad_fin,
                                  primas.id_prima,parentesco.parentesco,tbl_caract_cotizacion.id_poliza	 
                      from 
                               tbl_caract_cotizacion,primas,parentesco where tbl_caract_cotizacion.id_cliente_cotizacion=$elcotizacio and
...
//elmontotalprima
$montoprimatota=("select sum(montoprima) as totalprima from tbl_caract_cotizacion where id_cliente_cotizacion=$elcotizacio;");
...
$queplan=("select polizas.nombre_poliza,polizas.deducible,ramos.ramo,polizas.id_poliza 
from polizas,tbl_caract_cotizacion,ramos where 
tbl_caract_cotizacion.id_cliente_cotizacion=$elcotizacio and
...
//para ver si tiene maternidad 
      while($tendmatern=asignar_a($repqplan,NULL,PGSQL_ASSOC)){
          ...
          $vermaterni=("select tbl_caract_cotizacion.id_prima,tbl_caract_cotizacion.id_poliza,propiedades_poliza.monto 
from tbl_caract_cotizacion,primas,propiedades_poliza
where
       tbl_caract_cotizacion.id_cliente_cotizacion=$elcotizacio and
       tbl_caract_cotizacion.id_prima=primas.id_prima and
...
<tr>
    ...
    <br>
    <br>
		<td colspan=4 align="center" class="titulo3"><strong>Cotizaci&oacute;n Plan de Salud Individual No. <?echo $numcotiza?></strong></td>
	</tr>
	<tr>
...
<table   class="tabla_citas"  cellpadding=0 cellspacing=0 border=1>
         ...
         <tr>
                  <?if($linea==1){?>
                        <td rowspan=1 colspan=1><?echo $elramopoli?></td>
                   <?}else{?>
        ...
        <tr>
         ...
         <tr>
          ...
          <table   class="tabla_citas"  cellpadding=0 cellspacing=0 border=1>                 
          <?while($polizas=asignar_a($repqplan1,NULL,PGSQL_ASSOC)){
               $mipoli=$polizas[id_poliza];
               $caractpoliza=("select tbl_caract_poliza.caracteristica,tbl_tipo_caract.tipo_caract,tbl_caract_poliza.id_tipo_caract
  from
         tbl_caract_poliza,tbl_tipo_caract
  where
       ...
       tbl_tipo_caract.id_tipo_caract;");
            ...
            ?>
                <tr>
                       <td class="tdtituloss" colspan=1><label style="font-size: 8pt"><?echo $caracpoliza[caracteristica]?></label></td>
                </tr>
         ...
         <?}
          ...
          <?
            ...
            ?>
                <tr>
                       <td class="tdtituloss" colspan=1><label style="font-size: 8pt"><?echo $caracpolizamate[caracteristica]?></label></td>
                </tr>
