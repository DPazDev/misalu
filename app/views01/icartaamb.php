...
$q_proceso=("select entes.nombre as ente,clientes.*,procesos.*,servicios.*,tipos_servicios.*,gastos_t_b.* from entes,procesos,gastos_t_b,servicios,tipos_servicios,clientes,titulares where procesos.nu_planilla='$proceso' and gastos_t_b.id_proceso=procesos.id_proceso and gastos_t_b.id_servicio=servicios.id_servicio and gastos_t_b.id_tipo_servicio=tipos_servicios.id_tipo_servicio and titulares.id_titular=procesos.id_titular and titulares.id_cliente=clientes.id_cliente and titulares.id_ente=entes.id_ente");
...
$q_gastos=("select * from gastos_t_b,procesos where gastos_t_b.id_proceso=procesos.id_proceso and procesos.nu_planilla='$proceso'");
$r_gastos=ejecutar($q_gastos);
$q_gastos1=("select * from gastos_t_b,procesos where gastos_t_b.id_proceso=procesos.id_proceso and procesos.nu_planilla='$proceso'");
...
<tr>
<td colspan=4 class="datos_cliente">
M&eacute;rida Edo. M&eacute;rida.
</td>
</tr>
<tr>
<td colspan=4 class="datos_cliente">
