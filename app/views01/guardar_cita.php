...
if ($tipcon==26) {
	...
	id_proveedor,id_tipo_servicio,id_servicio,monto_reserva,monto_aceptado,monto_pagado,fecha_cita,hora_cita,id_proveedor_ref) 
	values ('$f_cproceso[id_proceso]','$especialidad','$descripcion','$fechacreado','$hora','0',' 
	','$id_proveedor','5','4','$f_especialidad[monto]','$f_especialidad[monto]','$f_especialidad[monto]','$fechacita','$horacita','$id_proveedor_ref');"; 
...
else
{
	...
	{	
		...
		$r_gastos="insert into gastos_t_b (id_proceso,nombre,descripcion,fecha_creado,hora_creado,id_cobertura_t_b,enfermedad,id_proveedor,id_tipo_servicio,id_servicio,monto_reserva,monto_aceptado,monto_pagado,fecha_cita,hora_cita,id_proveedor_ref) 
		values ('$f_cproceso[id_proceso]','$especialidad','$descripcion','$fechacreado','$hora','$id_cobertura',' ','$id_proveedor','10','4','$montototal','$montototal','$montototal','$fechacita','$horacita','$id_proveedor_ref');";
...
if ($paso==1){
	...
	<tr>		
		<td colspan=4 class="titulo_seccion">La Orden  Numero <?php echo $f_cproceso[id_proceso] ?> se Registro con Exito
			<a href="#" OnClick="reg_cita();" class="boton">Registrar otra Cita</a>
			<a href="#" OnClick="ir_principal();" class="boton">Salir</a>
		</td>	
	</tr>
