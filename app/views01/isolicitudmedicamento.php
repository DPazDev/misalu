...
<td align="right"  class="datos_cliente">Numero Planilla: <?php echo $proceso;?></td>
</td>
</tr>
<tr>
<td colspan=4 class="titulo3"> <hr></hr>
...
<td class="datos_cliente"><?php if ($id_beneficiario==0)
{
...
<td class="datos_cliente"><?php echo "$f_clientesb[nombres] $f_clientesb[apellidos] $nombre_clienteb $apellido_clienteb "?></td>
</td>
</tr>
<tr>
<td colspan=4 class="titulo3"> <hr></hr>
...
<tr>
<td class="datos_cliente"><br><br>Diagn&oacute;stico </td>
<td class="datos_cliente"><br><br>______________________________________________________________________________________</td>
</tr>
<tr>
<td colspan=4 class="titulo3"> <hr></hr>
