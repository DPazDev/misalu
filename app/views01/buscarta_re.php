...
?>
    <tr> <td colspan=4 class="titulo_seccion"> Esta Orden ya Tiene una Carta de Rechazo <?php echo $rechazo;?>
    <?php
...
<tr> <td colspan=4 class="titulo_seccion"> Datos de la Carta de Rechazo
...
<input class="campos" type="text" id="tipo_paragrafo_<?php echo $i?>" name="tipo_paragrafo" maxlength=128 size=15 value="<?php echo $f_paragrafo[tipo_paragrafo]?>"    ><input class="campos" type="checkbox" <?php echo $ban ?> id="check_<?php echo $i?>" name="checkl" maxlength=128 size=20 value="">  
			</td>
			<td colspan=3 class="tdcampos"><textarea class="campos"  id="paragrafo_<?php echo $i?>" name="paragrafo" cols=70 rows=3><?php echo $f_paragrafo[paragrafo]?></textarea></td>
...
<td class="tdtitulos" colspan=1>
		Seleccione el Tipo de Rechazo
		</td>
		<td class="tdcampos" colspan=1 align="left">
		
		
		<select id="tipo_rechazo" name="tipo_rechazo" class="campos">
		
		<option value="1" >Total</option>
		<option value="2" >Parcial</option>
	</select>
		</td>
			<td colspan=2 class="tdtitulos"><a href="#"  OnClick="carta_rechazo();" class="boton"> Procesar Carta de Rechazo Parcial </a>
			</td>
</tr>
