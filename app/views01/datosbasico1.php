...
$buscdatclien=("select clientes.cedula,clientes.nombres,clientes.apellidos,clientes.email,clientes.direccion_hab,clientes.telefono_hab,
...
<table class="tabla_cabecera5"  cellpadding=0 cellspacing=0>
     <tr>
       ...
       <td class="tdcampos"  colspan="1"><input type="text" class="campos" id="cedclien" value="<?echo $datdatclien['cedula'];?>"> </td> 
        ...
        <td class="tdcampos"  colspan="1"><input type="text" id="correoclien" class="campos" size="30" value="<? echo $datdatclien[email];?>"></td> 
     </tr>
      <tr>
