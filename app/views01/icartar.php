...
<tr>
	...
	Estimado(a) Se&ntilde;or(a):
		...
		<tr>	
			<td colspan=4 class="datos_cliente"> <br>
Por medio de la presente se informa que después de haber analizado su solicitud de 
reembolso número <?php echo $proceso; ?> presentada el 
<?php echo camfecha($fecha_recibido);?>, nos vemos en el deber de declinar la responsabilidad en la cancelación de su solicitud <?php 
echo "($motivo)"; ?> , según  lo indicado en la exclusión de las condiciones particulares, que se describe a continuación: 
			</td>
