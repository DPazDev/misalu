<?php
 ...
 if ($tipclie=='Titular'){
 $datipo='Titular';
 $buscamotomador=("select * from coberturas_t_b where id_titular=$eltitu and id_beneficiario=0;");
...
if($cantidtomador==0){
	 echo"<table class=\"tabla_cabecera3\" cellpadding=0 cellspacing=0>
       <tr>
	  <td colspan=4 class=\"titulo_seccion\"><label style=\"color: #ff0000\"><h1>El titular es Tomador NO POSEE COBERTURA!!!</h1></label></td>
       </tr>
     </table>";
 }else{    
 echo"<table class=\"tabla_cabecera3\" cellpadding=0 cellspacing=0>
