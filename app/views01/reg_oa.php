...
<tr>		<td colspan=4 class="titulo_seccion">Registrar Orden </td>	</tr>
	<tr>
		...
		<td class="tdcampos"><input class="campos" type="text" name="cedula" maxlength=128 size=20 value=""   OnChange="if($F(SelecTipoCliente)=='*'){}else{tipos_clientes();}" onkeypress="return event.keyCode!=13"></td>
<?php
...
<td  class="tdcampos">
		<select name="tipo_cliente" id="SelecTipoCliente" class="campos" OnChange="tipos_clientes();">
