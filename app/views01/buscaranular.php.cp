...
///////////////////////////////////////////---->
  if($f_admin[id_departamento] == 18)
 			{ $mostrarprecios=false; 
			$mostraracion=false; 	
			
 			}
 			else {$mostrarprecios=true;
					$mostraracion=true; 		
						echo"<h1>iddependencia:$f_admin[id_departamento]</h1>";			
 			}
 	//NO VER GASTOS 'ENFERMEROS'
...
<?php echo $f_poliza[nu_planilla]?>
   ...
   <tr>
	...
	<tr>
				...
				<td colspan=1 class="tdcampos"> <?php if($mostrarprecios==true) { echo $f_poliza1[monto_aceptado];} ?>   </td>
		<?php
		}
		?>
	</tr>		

		<?php if($mostrarprecios==true) {?>
			<tr>
	...
	<?php 
}//////////////////Fin No mostrar monstos para enfermeros	
...
<?php if ($f_poliza[id_estado_proceso]==2 || $f_poliza[id_estado_proceso]==4){
         if($f_admin[id_departamento] == 17  or $f_admin[id_departamento] == 18){
...
<!--33 <?php if($f_admin[id_departamento] == 18){?><a href="#" OnClick="candidato_pago_orden();"  class="boton">Candidato Pago</a> <?php }?><!--33-->
<?php } 
    }
}?>
...
else
{
	...
	if (($mostraracion==true)&&($f_poliza[id_tipo_servicio]==0 and ($f_poliza[id_servicio]==2 || $f_poliza[id_servicio]==3 || $f_poliza[id_servicio]==8 || $f_poliza[id_servicio]==11  || $f_poliza[id_servicio]==13 || $f_poliza[id_servicio]==10) ))
	{
?>
<tr> <td colspan=4 class="titulo_seccion"> Imprimir Cartas de Compromiso</td></tr>
	...
	{
		if($mostrarprecios==true){/////NO MOSTRAR A ENFERMEROS		
...
<td>
		...
		<a href="#" OnClick="anular_orden();" class="boton">Anular Orden</a> 
		<a href="#" OnClick="anular_orden_no_doctor();" class="boton">Anular Orden No Asistio Doctor </a> 
	<!--33 <?php if($f_admin[id_departamento] == 18){?><a href="#" OnClick="candidato_pago_orden();"  class="boton">Candidato Pago</a> </td> <?php }?> <!--33-->
<?php
    }
}
?>	
...
if (($mostraracion==true)&&($f_espera[id_estado_proceso]==7 || $f_espera[id_estado_proceso]==11 || $f_espera[id_estado_proceso]==16)) {
?>
...
<tr>
		...
		if($mostraracion==true){/*  ver imprimir */	?> <a href="javascript: imprimir(<?php echo $url; ?>);" class="boton"> Reembolso en Espera </a><?php }/* fin ver imprimir */ ?>
...
<?php if($mostraracion==true){/* fin ver imprimir */ ?><tr> <td colspan=4 class="titulo_seccion"> Imprimir</td></tr><?php }/* fin ver imprimir */?>
...
<tr>
        ...
        if ($f_poliza[id_estado_proceso]==2 || $f_poliza[id_estado_proceso]==4){
			$url="'views01/ireembolso.php?proceso=$proceso&si=0'";
if($mostraracion==true){/* fin ver imprimir */	?> <a href="javascript: imprimir(<?php echo $url; ?>);" class="boton"> Reembolso sin Espera </a><?php } /* fid ver imprimir */?>
			<?php } 
			if  ($f_poliza[id_estado_proceso]<>11 and $f_poliza[id_estado_proceso]<>10 and $num_filasf==0) {
				$url="'views01/irevisionc.php?proceso=$proceso'";
if($mostraracion==true){/* fin ver imprimir */?><a href="javascript: imprimir(<?php echo $url; ?>);"class="boton"> Comentarios</a><?php }/*fin ver imprimir*/?>
            <?php if ($f_poliza[id_estado_proceso]==2 || $f_poliza[id_estado_proceso]==4){
                      if($f_admin[id_departamento] == 17 or $f_admin[id_departamento] == 18){
?>
		<td colspan=4 class="tdtitulos">
...
?>
	...
	else
	{
		...
		if($mostraracion==true){/////NO MOSTRAR A ENFERMEROS
