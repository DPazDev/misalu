...
$cogerent=$_REQUEST['cogerent'];
$cogerent=strtoupper("$cogerent");
...
$mod_proceso="update procesos set id_estado_proceso='14',fecha_modificado='$fechacreado',hora_modificado='$hora',comentarios='$cooperador',comentarios_gerente='$cogerent' where procesos.id_proceso=$proceso";
