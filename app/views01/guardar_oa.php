...
else
{
	...
	if($montoh<1){
					...
					if($ProvServicios[id_s_p_proveedor]>'0'){
						...
						$tipo_monto=$dserv[2];//porcentaje o monto en BS o USD
						$id_monedaser=$dserv[3];//moneda
...
if ($edoproceso==13) ///13 ESTADo: EN ESPERA
			...
			if($montoTerceros>0){
				$nombre='SERVICIOS POR TERCEROS';
				$decrict='SERVICIOS POR TERCEROS';
				$montorecerva=$montoTerceros;
				$monto=0.0002;
				$tiposervTer=14;
				$servicioTer=$servicio;
				$q.="insert into gastos_t_b (id_proceso,id_organo,nombre,descripcion,fecha_creado,hora_creado,id_cobertura_t_b,enfermedad,id_proveedor,id_tipo_servicio,id_servicio,factura,monto_reserva,monto_aceptado,monto_pagado,fecha_cita,continuo,unidades,fecha_continuo)
				values ('$f_cproceso[id_proceso]','$organo','$nombre','$decrict','$fechacreado','$hora','$id_cobertura','$enfermedad','$id_proveedor','$tiposervTer','$servicioTer','$factura','$montorecerva','$monto','$montorecerva','$fecharci','$tc','$t','$fechacf');";
			}
			...
			if($montoTerceros>0){
				...
				(id_proceso,id_organo,nombre,descripcion,fecha_creado,hora_creado,id_cobertura_t_b,enfermedad,
				id_proveedor,id_tipo_servicio,id_servicio,monto_reserva,monto_aceptado,monto_pagado,fecha_cita,hora_cita)
				values ('$proceso','$organo','$especialidad','$decrict','$fechacreado','$hora','$id_cobertura','$enfermedad','$id_proveedor','$tiposerv','$servicio','$montorecerva','$monto','$monto','$fecharci','$horac');";
			...
			if($montoTerceros>0){
				...
				$servicioTer=$servicio;
				$q.="insert into gastos_t_b (id_proceso,id_organo,nombre,descripcion,fecha_creado,hora_creado,comentarios,id_cobertura_t_b,enfermedad,id_proveedor,id_tipo_servicio,id_servicio,monto_reserva,monto_aceptado,monto_pagado,fecha_cita)
				values ('$f_cproceso[id_proceso]','$organo','$decrict','$examen','$fechacreado','$hora','$coment','$id_cobertura','$enfermedad','$id_proveedor','$tiposervTer','$servicioTer','$montorecerva','$monto','$monto','$fecharci');";
			...
			if($montoTerceros>0){
				...
				$servicioTer=$servicio;
				$q.="insert into gastos_t_b (id_proceso,id_organo,nombre,descripcion,fecha_creado,hora_creado,id_cobertura_t_b,enfermedad,id_proveedor,id_tipo_servicio,id_servicio,monto_reserva,monto_aceptado,monto_pagado,fecha_cita,unidades)
								values ('$proceso','$organo','$decrict','$nombre','$fechacreado','$hora','$id_cobertura','$enfermedad','$id_proveedor','$tiposervTer','$servicioTer','$montorecerva','$monto','$monto','$fecharci','$factor');";
		...
		if ($proceso>0 && $edoproceso<>13){
			//echo "<h1>registrar mas gastos a un procesos que ya existe<br></h1>";
						...
						if($montoTerceros>0){
							...
							$servicioTer=$servicio;
							$q.="insert into gastos_t_b (id_proceso,id_organo,nombre,descripcion,fecha_creado,hora_creado,id_cobertura_t_b,enfermedad,id_proveedor,id_tipo_servicio,id_servicio,factura,monto_reserva,monto_aceptado,monto_pagado,fecha_cita,continuo,unidades,fecha_continuo)
							values ('$f_cproceso[id_proceso]','$organo','$nombre','$decrict','$fechacreado','$hora','$id_cobertura','$enfermedad','$id_proveedor','$tiposervTer','$servicioTer','$factura','$montorecerva','$monto','$monto','$fecharci','$tc','$t','$fechacf');";
						}
						$q.="
						commit work;
						";
						...
						//CUENTAS POR TERCEROS
						if($montoTerceros>0){
							$especialidad='SERVICIOS POR TERCEROS';
							$decrict='SERVICIOS POR TERCEROS';
							$montorecerva=$montoTerceros;
							$monto=0.0002;
							$tiposervTer=14;
							...
							(id_proceso,id_organo,nombre,descripcion,fecha_creado,hora_creado,id_cobertura_t_b,enfermedad,
							id_proveedor,id_tipo_servicio,id_servicio,monto_reserva,monto_aceptado,monto_pagado,fecha_cita)
							values ('$proceso','$organo','$especialidad','$decrict','$fechacreado','$hora','$id_cobertura','
							$enfermedad','$id_proveedor','$tiposervTer','$servicioTer','$montorecerva','$monto','$monto','$fecharci');";
				...
				{//echo"<h1>-<preventivas>-</h1>";
						...
						if($montoTerceros>0){
							...
							$r_Servicio="insert into gastos_t_b
								(id_proceso,id_organo,nombre,descripcion,fecha_creado,hora_creado,id_cobertura_t_b,enfermedad,
								id_proveedor,id_tipo_servicio,id_servicio,monto_reserva,monto_aceptado,monto_pagado,fecha_cita,hora_cita)
								values ('$f_cproceso[id_proceso]','$organo','$especialidad','$decrict','$fechacreado','$hora','0','
								$enfermedad','$id_proveedor','$tiposervTer','$servicioTer','$montorecerva','$monto','$monto','$fecharci','$horac');";
								$f_Servicio=ejecutar($r_Servicio);
							}
					...
					/* **** Fin de Cargar Consulta Preventiva **** */
						...
						if($montoTerceros>0){
							...
							values ('$f_cproceso[id_proceso]','$organo','$especialidad','$decrict','$fechacreado','$hora','$id_cobertura','$enfermedad','$id_proveedor','$tiposervTer','$servicioTer','$montorecerva','$monto','$monto','$fecharci','$horac');";
							$f_Servicio=ejecutar($r_Servicio);
				...
				if (($tiposerv==6) || ($tiposerv==8) || ($tiposerv==12))
					{
						...
						if($montoTerceros>0){
							...
							$servicioTer=$servicio;
							$q.="insert into gastos_t_b (id_proceso,id_organo,nombre,descripcion,fecha_creado,hora_creado,comentarios,id_cobertura_t_b,enfermedad,id_proveedor,id_tipo_servicio,id_servicio,monto_reserva,monto_aceptado,monto_pagado,fecha_cita,hora_cita)
							values ('$f_cproceso[id_proceso]','$organo','$decrict','$examen','$fechacreado','$hora','$coment','$id_cobertura','$enfermedad','$id_proveedor','$tiposervTer','$servicioTer','$montorecerva','$monto','$monto','$fecharci','$horac');";
							}
						$q.="
						commit work;
						";
...
if($id_proveedor=='' || $id_proveedor==0 || $id_proveedor<=0){
							...
							if ($f_admin[id_ciudad]==1)
								...
								if($montoTerceros>0){
									...
									$servicioTer=$servicio;
									$q.="insert into gastos_t_b (id_proceso,id_organo,nombre,descripcion,fecha_creado,hora_creado,id_cobertura_t_b,enfermedad,id_proveedor,id_tipo_servicio,id_servicio,monto_reserva,monto_aceptado,monto_pagado,fecha_cita,hora_cita,unidades)
									values ('$f_cproceso[id_proceso]','$organo','$decrict','$nombre','$fechacreado','$hora','$id_cobertura','$enfermedad','$id_proveedor','$tiposervTer','$servicioTer','$montorecerva','$monto','$monto','$fecharci','$horac','$factor');";
										}
								$q.="
								commit work;
								";
...
//				echo "Guardar reembolso ambulatorio";
		...
		if($montoTerceros>0){
			...
			$servicioTer=$servicio;
					$q.="insert into gastos_t_b (id_proceso,id_organo,nombre,descripcion,fecha_creado,hora_creado,id_cobertura_t_b,enfermedad,id_proveedor
			,id_tipo_servicio,id_servicio,factura,monto_reserva,monto_aceptado,monto_pagado,fecha_cita,continuo,unidades,fecha_continuo)
			values ('$f_cproceso[id_proceso]','$organo','$nombre','$decrict','$fechacreado','$hora','$id_cobertura','$enfermedad','$id_proveedor','$tiposervTer'
			,'$servicioTer','$factura','$montorecerva','$monto','$monto','$fecharci','$tc','$t','$fechacf');";
		}
		$q.="
		commit work;
		";
			...
			if ($edoproceso==13)
				{/* **** registrar procesos que se encuentren en estado de ESPERA(13) **** */
							...
							values ('$f_cproceso[id_proceso]','$organo','$nombre','$decrict','$fechacreado','$hora','$id_cobertura','$enfermedad','$id_proveedor','$tiposervTer','$servicioTer','$factura','$montorecerva','$monto','$monto','$fecharci','$tc','$t','$fechacf');";
								...
								if($montoTerceros>0){
										...
										(id_proceso,id_organo,nombre,descripcion,fecha_creado,hora_creado,id_cobertura_t_b,enfermedad,
										id_proveedor,id_tipo_servicio,id_servicio,monto_reserva,monto_aceptado,monto_pagado,fecha_cita,hora_cita)
										values ('$proceso','$organo','$especialidad','$decrict','$fechacreado','$hora','$id_cobertura','$enfermedad','$id_proveedor','$tiposervTer','$servicioTer','$monto','$monto','$monto','$fecharci','$horac');";
										$f_servicio=ejecutar($r_servicio);
									}
								}
					...
					else
						{
							...
							if($montoTerceros>0){
									...
									id_proveedor,id_tipo_servicio,id_servicio,monto_reserva,monto_aceptado,monto_pagado,fecha_cita)
									values ('$proceso','$organo','$especialidad','$decrict','$fechacreado','$hora','$id_cobertura','
									$enfermedad','$id_proveedor','$tiposervTer','$servicioTer','$monto','$monto','$monto','$fecharci');";
									$f_gastos=ejecutar($r_gastos);}
							}
				...
				else
				{
						if ($proceso==0){
								...
								$num_filas=num_filas($r_especialidad);
								if ($num_filas==0){
										$q_tiposer="select * from tipos_servicios where tipos_servicios.id_tipo_servicio='$tiposerv'";
										$r_tiposer=ejecutar($q_tiposer);
										$f_tiposer=asignar_a($r_tiposer);
										$especialidad=	$f_tiposer['tipo_servicio'];
										$id_especialidad=0;
								...
								// Daniel modificación 03-2024
								if ($montog>0){
									$montorecerva=0;
								$r_gastos="insert into gastos_t_b (id_proceso,id_organo,nombre,descripcion,fecha_creado,hora_creado,id_cobertura_t_b,enfermedad,id_proveedor,id_tipo_servicio,id_servicio,factura,monto_reserva,monto_aceptado,monto_pagado,retencion,fecha_cita)
								values ('$f_cproceso[id_proceso]','$organo','$decrip','GASTOS CLINICOS','$fechacreado','$hora','$id_cobertura','$enfermedad','$id_proveedor','18','$servicio','$numpro','$montorecerva','$montog','$montog','1','$fecharci');";
								$f_gastos=ejecutar($r_gastos);
								}
								if ($montoh>0){
									$montorecerva=$montoh;
								$r_gastos1="insert into gastos_t_b (id_proceso,id_organo,nombre,descripcion,fecha_creado,hora_creado,id_cobertura_t_b,enfermedad,id_proveedor,id_tipo_servicio,id_servicio,factura,monto_reserva,monto_aceptado,monto_pagado,retencion,fecha_cita)
								values ('$f_cproceso[id_proceso]','$organo','$decrip','HONORARIOS MEDICOS','$fechacreado','$hora','$id_cobertura','$enfermedad','$id_proveedor','10','$servicio','$numpro','$montorecerva','$montoh','$montoh','0','$fecharci');";
								$f_gastos1=ejecutar($r_gastos1);
								}
								if ($montoo>0){
									$montorecerva=0;
