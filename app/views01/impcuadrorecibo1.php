...
<table   class="tabla_citas"  cellpadding=0 cellspacing=0 border=1>
          ...
          <? 
            ...
            ?> 
                <tr>
                  ...
                  <td colspan=4 class="tdtituloss"><label style="font-size: 8pt"><?echo "$lomotbeni[monto_prima] $moneda"?></label></td>                  
              </tr>
          <?
              $nombrpersona="";
              }
        ...
        <tr>
                  ...
                  <td colspan=4 class="tdtituloss"><label style="font-size: 8pt"><strong><?echo  "$montobol $moneda"?></strong></label></td>                  
        </tr>
        <tr>
