...
$q_morbilidad=("select
				...
				(SELECT gastos_t_b.nombre || '' || gastos_t_b.descripcion FROM gastos_t_b WHERE gastos_t_b.id_proceso=procesos.id_proceso LIMIT 1) as nomgasto,
				gastos_t_b.fecha_cita,
				gastos_t_b.enfermedad,
				admin.nombres as adminomb,
				admin.apellidos as adminapell
		from
				clientes,
				procesos,
				gastos_t_b,
...
//modificaion hecha ing franklin Mosalve se agrega la clausula id_estado_proceso!=14'anulados' requerimiento de historias medicas
...
<tr>
    ...
    $enfermedad=$f_morbilidad[enfermedad];
...
?>
		...
		<td class="datos_cliente3"><?php echo $enfermedad?></td>
