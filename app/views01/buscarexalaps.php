...
$ban="";
 while($f_examen=asignar_a($r_examen,NULL,PGSQL_ASSOC)){
	...
	<tr>
		...
		<input class="campos" type="text" id="honorarios_<?php echo $i?>"  name="examen" maxlength=128 size=20 value="<?php echo $f_examen[hono_privados]?>"  OnChange="return validarNumero(this);" >
