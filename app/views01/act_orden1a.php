...
if ($f_poliza[id_servicio]==9 || $f_poliza[id_servicio]==6 || $f_poliza[id_servicio]==14 || $f_admin[id_tipo_admin]==14){
    $bloqueo="";
    }
    else
    {
...
<td colspan=2 >
                <select style="width: 300px;" OnChange="verificarprop(this);"  id="id_proveedorp" name="id_proveedor" class="campos">
                <?php $q_p=("select
													especialidades_medicas.especialidad_medica,
													proveedores.id_proveedor,
													personas_proveedores.*,
		...
		<?php 
				$q_proveedorp="select 
											...
											where 
														...
														and gastos_t_b.id_proceso='$proceso'";
$r_proveedorp=ejecutar($q_proveedorp);
$num_filasp=num_filas($r_proveedorp);
	if ($num_filasp == 0) { 
$value=0;
...
<tr> <td colspan=4 class="titulo_seccion">Esta orden esta Facturada en los Siguientes Numeros de Factura</td>
	...
	?>
        ...
        <tr>
                ...
                if ($f_poliza[id_estado_proceso]==2 || $f_poliza[id_estado_proceso]==4 || ($f_admin[id_tipo_admin]==14 and $f_cliente[id_tipo_ente]==4) || ($f_admin[id_tipo_admin]==7 and $f_cliente[id_tipo_ente]==4)){
				?>
