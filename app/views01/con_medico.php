...
<tr>
	<td colspan=4 class="titulo_seccion">Citas Medicas <?php
...
<tr>
	<td
		colspan=2 class="tdcamposc"> <input type="hidden" name="fecha" value="<?php echo $fecha ?>">
	</td>
</tr>
...
<tr>
	...
	<td colspan=3 class="tdcampos"><textarea name="comenope" cols=72 rows=1 class="campos"><?php echo $f_cita1[comentarios]?></textarea>
	<td class="tdcampos"><input class="campos" type="hidden" name="horac" maxlength=128 size=20 value="" ></td>
</tr>
<tr>

	<td colspan=2 class="tdtitulos">* Ingrese la Hora para la Cita:
 		<input type="text" placeholder="8:00am" name="horacita" id="horacita" class="campos">
	</td>
