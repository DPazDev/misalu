...
<br>
  ...
  <label class="boton" title="Buscar el titular" style="cursor:pointer" onclick="nuevobenfPRO(); return false;" >Buscar</label>  </td>
</tr>  
</table>  
<input type='hidden' id='ceduladelbenefi' value='<?echo $cedbenfi?>'>
<div id='cuantostitulare'></div>