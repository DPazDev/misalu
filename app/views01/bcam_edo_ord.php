...
/* **** selecciono los tipo de estados de proceso **** */
$q_estadop=("select * from estados_procesos where (id_estado_proceso=2 or id_estado_proceso=7) order by estado_proceso");
...
$q_poliza="select procesos.nu_planilla,procesos.comentarios,procesos.comentarios_gerente,procesos.comentarios_medico,procesos.factura_final,procesos.fecha_factura_final,procesos.no_clave,procesos.fecha_ent_pri,servicios.servicio,estados_procesos.id_estado_proceso,estados_procesos.estado_proceso,gastos_t_b.descripcion as descrip,gastos_t_b.nombre,gastos_t_b.id_tipo_servicio,gastos_t_b.id_servicio,gastos_t_b.id_proveedor,gastos_t_b.fecha_cita,gastos_t_b.hora_cita,gastos_t_b.enfermedad,gastos_t_b.monto_aceptado,procesos.fecha_recibido,procesos.comentarios,coberturas_t_b.id_cobertura_t_b,coberturas_t_b.id_titular,coberturas_t_b.id_beneficiario,polizas.* from polizas,coberturas_t_b,gastos_t_b,procesos,servicios,estados_procesos,propiedades_poliza where polizas.id_poliza=propiedades_poliza.id_poliza and propiedades_poliza.id_propiedad_poliza=coberturas_t_b.id_propiedad_poliza and coberturas_t_b.id_cobertura_t_b=gastos_t_b.id_cobertura_t_b and gastos_t_b.id_proceso=procesos.id_proceso and procesos.id_proceso='$proceso' and procesos.id_estado_proceso=estados_procesos.id_estado_proceso and gastos_t_b.id_servicio=servicios.id_servicio";
...
$q_poliza="select procesos.comentarios,procesos.comentarios_gerente,procesos.comentarios_medico,procesos.factura_final,procesos.fecha_factura_final,procesos.no_clave,estados_procesos.id_estado_proceso,estados_procesos.estado_proceso,procesos.* from estados_procesos,procesos where procesos.id_proceso='$proceso' and procesos.id_estado_proceso=estados_procesos.id_estado_proceso and estados_procesos.id_estado_proceso>=13 and estados_procesos.id_estado_proceso<=14";
$r_poliza=ejecutar($q_poliza);
...
$q_poliza="select procesos.nu_planilla,procesos.comentarios,procesos.comentarios_gerente,procesos.comentarios_medico,procesos.factura_final,procesos.fecha_factura_final,procesos.no_clave,servicios.servicio,estados_procesos.id_estado_proceso,estados_procesos.estado_proceso,gastos_t_b.descripcion as descrip,gastos_t_b.nombre,gastos_t_b.id_tipo_servicio,gastos_t_b.id_servicio,gastos_t_b.id_proveedor,gastos_t_b.fecha_cita,gastos_t_b.hora_cita,gastos_t_b.enfermedad,gastos_t_b.monto_aceptado,procesos.fecha_recibido,procesos.comentarios  from gastos_t_b,procesos,servicios,estados_procesos where gastos_t_b.id_proceso=procesos.id_proceso and procesos.id_proceso='$proceso' and procesos.id_estado_proceso=estados_procesos.id_estado_proceso and gastos_t_b.id_servicio=servicios.id_servicio";
$r_poliza=ejecutar($q_poliza);
...
if ($f_tiposervicio[id_tipo_servicio]==5) 
{
	$q_poliza1="select gastos_t_b.fecha_creado,gastos_t_b.hora_creado,gastos_t_b.id_cobertura_t_b,gastos_t_b.id_gasto_t_b,gastos_t_b.id_organo,gastos_t_b.retencion,gastos_t_b.descripcion as descrip,gastos_t_b.nombre,gastos_t_b.id_tipo_servicio,gastos_t_b.id_servicio,gastos_t_b.id_proveedor,gastos_t_b.fecha_cita,gastos_t_b.hora_cita,gastos_t_b.enfermedad,gastos_t_b.monto_reserva,gastos_t_b.monto_aceptado,gastos_t_b.factura,procesos.fecha_recibido,procesos.comentarios from gastos_t_b,procesos where gastos_t_b.id_proceso=procesos.id_proceso and procesos.id_proceso='$proceso'";
...
/* **** busco si es titular **** */
$q_cliente=("select clientes.id_cliente,clientes.nombres,clientes.apellidos,clientes.cedula,estados_clientes.estado_cliente,titulares.id_titular,titulares.id_ente,entes.nombre,entes.id_tipo_ente from clientes,titulares,estados_t_b,estados_clientes,entes,procesos
...
beneficiarios.id_beneficiario,beneficiarios.id_titular,entes.nombre,entes.id_tipo_ente 
...
from propiedades_poliza,coberturas_t_b,gastos_t_b,procesos,admin,servicios,estados_procesos where
...
<tr>
	...
	<tr>
		...
		<td class="tdtitulos"> Enfermedad</td>
                ...
                <?php echo $f_datos[enfermedad]?></td>
	</tr>
	<tr>
...
<?php echo $f_poliza[fecha_cita]?>
   ...
   <tr>
				...
				<td class="tdtitulos">Cuadro Medico</td>
              	<td class="tdcampos">
              	 <textarea class="campos" name="cumedico" id="cumedico" cols=18 rows=3 maxlength=120><?php echo $f_poliza[enfermedad]?></textarea> 
              	</td>
	</tr>		
...
estados_clientes.estado_cliente,titulares.id_titular,titulares.id_ente,entes.nombre,entes.id_tipo_ente 
...
$id_tipo_ente=$f_clientet[id_tipo_ente];
...
<?php echo $f_poliza[fecha_cita]?>
   ...
   <tr>
				...
				<td class="tdtitulos">Cuadro Medico</td>
              	<td class="tdcampos"> 
<textarea class="campos" name="cumedico" id="cumedico" maxlength=120 cols=18 rows=3><?php echo $f_datos[enfermedad]?></textarea>              	
...
if ($f_espera[id_estado_proceso]==14 || $f_espera[id_estado_proceso]==7 || $f_espera[id_estado_proceso]==2 || $f_espera[id_estado_proceso]==4 || $f_espera[id_estado_proceso]==6){
?>
...
<tr>
	<td class="tdtitulos"></td>
        ...
        if (($f_admin[id_tipo_admin]==14 || $f_admin[id_tipo_admin]==15 || $f_admin[id_tipo_admin]==16 || $f_admin[id_tipo_admin]==7) and $id_tipo_ente==4)
                {
        ?>
		<td  class="tdtitulos"><a href="#" OnClick="camb_edo();" class="boton">Actualizar</a></td>
        <?php
        }
        ?>
           <?php if (($f_admin[id_tipo_admin]==7 || $f_admin[id_tipo_admin]==10 || $f_admin[id_tipo_admin]==11 || $f_admin[id_tipo_admin]==16) and $id_tipo_ente<>4)
                {
        ?>
		<td  class="tdtitulos"><a href="#" OnClick="camb_edo();" class="boton">Actualizar</a></td>
        <?php
