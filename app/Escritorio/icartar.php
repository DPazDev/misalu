...
$q_admin = "select admin.nombres,admin.apellidos,sucursales.sucursal,procesos.comentarios from admin, sucursales,procesos where procesos.id_proceso=$proceso and procesos.id_admin=admin.id_admin and admin.id_sucursal=sucursales.id_sucursal";
...
<tr>
	...
	Estimado(a) Se&ntilde;or(a):
		...
		<tr>	
			<td colspan=4 class="datos_cliente"> <br>
Por medio de la presente le informamos que despu&eacute;s de haber analizado su solicitud de 
reemboslo numero <?php echo $proceso; ?> presentada el 
<?php echo camfecha($fecha_recibido);?>, nos vemos en la obligaci&oacute;n de declinar la responsabilidad en la cancelaci&oacute;n de su solicitud <?php 
echo "($motivo)"; ?> , seg&uacute;n  lo indicado en la exclusiones de las condiciones particulares, que se describe a continuacion: 
			</td>
			
		</tr>
<tr>	
			<td colspan=4 class="datos_cliente"><br>
			<?php echo $f_admin[comentarios]; ?>
...
$log="IMPRIMIO A LA ORDEN NUMERO $proceso recibida en la fecha $fecha_recibido";
logs($log,$ip,$admin);
