...
$q_subdivision=("select * from subdivisiones,titulares_subdivisiones where titulares_subdivisiones.id_subdivision=subdivisiones.id_subdivision and titulares_subdivisiones.id_titular=$f_proceso[id_titular];  ");
$r_subdivision=ejecutar($q_subdivision);
$f_subdivision=asignar_a($r_subdivision);
...
<?php echo "$f_proceso[servicio] $f_proceso[tipo_servicio] Num. $proceso clave $f_proceso[no_clave]" ?>
</td>
</tr>
<tr>
<td colspan=4>
...
<?php echo "$f_proceso[ente] $f_subdivision[subdivision] " ?>
...
<tr> 
<td colspan=4 class="titulo3">
INFORMACION:  ESTIMADO USUARIO; NOS COMPLACE OFRECERLE NUESTROS PLANES DE EXCESO DE LIMITES A PRECIOS SOLIDARIOS, AUMENTE SU COBERTURA DE HC; CONSULTE CON NUESTROS EJECUTIVOS.
</td>
