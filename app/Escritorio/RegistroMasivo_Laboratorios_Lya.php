...
$filename = "BASE_DE_DATOS_LABORATORIOS_LYA.xls";
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
///EL ENTE
		$entclien='2266';//ID ENTE LABORATORIOS LYA CA
		$poliza='202';//ID PLAN CLINI LABORAL PLUS MEDICINA OCUPACIONAL
    ///Cambio de plan: renueva el y traslada todas las cualidades a la nueva
    $TrasladoPlan='52';////si desea cambiar de plan id de plan anterior
		$fecha=date("Y-m-d");
		$hora=date("H:i:s");
///contadores
		$clientesnuevos=0;
