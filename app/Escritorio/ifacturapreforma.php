...
$montosnoaprobado=("select * from gastos_t_b,procesos where gastos_t_b.id_proceso=procesos.id_proceso and 
                                                     ...
                                                     (gastos_t_b.id_tipo_servicio=27 or gastos_t_b.id_tipo_servicio=28) and 
...
<?php echo "$f_proceso[servicio] FACTURA PROFORMA Num. $f_proceso[nu_planilla] Clave: $f_proceso[no_clave]" ?>
</td>
</tr>
<tr>
<td colspan=4>
...
<tr>
			...
			<td  colspan=2 class="datos_cliente">MONTO TOTAL EXENTO O EXONERADO Bs.S. 
    		</td>
			
				<td colspan=1 class="datos_cliente"> <?php echo montos_print($monto); echo  $cero;?></td>
			</tr>
				<tr>
                <td  colspan=1 class="datos_cliente">
    		</td>
				<td  colspan=2 class="datos_cliente">Base imponible segun alicuota_% Bs.S. 
    		</td>
				...
				<td  colspan=2 class="datos_cliente">Monto Total del impuesto segun alicuota_% Bs.S. 
    		</td>
         ...
         if ($f_deducible[sum]>0)
        {
            ?>
				...
				<td  colspan=2 class="datos_cliente">MONTO DEDUCIBLE Bs.S. 
    		</td>
			
			
				<td  colspan=1 class="datos_cliente"> <?php echo montos_print($f_deducible[sum]);  ?></td>
			</tr>
<tr>
				...
				<td  colspan=2 class="datos_cliente">MONTO NO APROBADO Bs.S. 
				...
				<td  colspan=1 class="datos_cliente"> <?php echo montos_print($elmontonoaprobado);  echo  $cero;?></td>

			</tr>
				<tr>
                <td  colspan=1 class="datos_cliente">
    		</td>
				<td  colspan=2 class="datos_cliente">MONTO TOTAL DE LA VENTA Bs.S. 
    		</td>
			
			
				<td  colspan=1 class="datos_cliente"> <?php echo montos_print($monto - $f_deducible[sum] - $elmontonoaprobado);  echo  $cero;?></td>
			</tr>
	...
	<tr>
				...
				<td  colspan=1 class="datos_cliente"> <?php echo montos_print($monto - $elmontonoaprobado);  echo  $cero;?></td>
			</tr>
			<?php 
            }
            ?>
