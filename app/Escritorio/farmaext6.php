...
$buscarlconcepto=("select especialidades_medicas.especialidad_medica,especialidades_medicas.id_especialidad_medica from especialidades_medicas where especialidades_medicas.id_especialidad_medica=$espcialmedic;");
      ...
      <tr>  
        ...
        for ($f=0;$f<$cuantos;$f++){
			...
			$guardoengatotb=("insert into gastos_t_b(id_proceso,nombre,descripcion,fecha_creado,hora_creado,id_cobertura_t_b,
											...
											monto_pagado,fecha_cita,hora_cita,continuo,unidades,fecha_continuo) 
                                    ...
                                    '$subtotalprod','$fecha','$hora','$tratamiento','$cantidades',$fechattconti);"); 
	...
	//guardo en proceso para crear el gasto
        ...
        for ($f=0;$f<$cuantos;$f++){
			...
			$guardoengatotb=("insert into gastos_t_b(id_proceso,nombre,id_insumo,descripcion,
					    ...
					    monto_pagado,fecha_cita,hora_cita,continuo,unidades,fecha_continuo,id_proveedor) 
                                    ...
                                    '$subtotalprod','$fecha','$hora','$tratamiento','$cantidades',$fechattconti,$provees);"); 
			$repguardoengatotb=ejecutar($guardoengatotb);	
			...
			$buscarlproducto=("select tbl_insumos_almacen.cantidad from tbl_insumos_almacen where 
                                                      ...
                                                      tbl_insumos_almacen.id_dependencia=$dependarestar;");
