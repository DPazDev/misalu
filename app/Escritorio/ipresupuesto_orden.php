...
$q_proceso=("select entes.nombre as ente,clientes.*,procesos.*,servicios.*,tipos_servicios.*,gastos_t_b.* from entes,procesos,gastos_t_b,servicios,tipos_servicios,clientes,titulares where procesos.id_proceso='$proceso' and gastos_t_b.id_proceso=procesos.id_proceso and gastos_t_b.id_servicio=servicios.id_servicio and gastos_t_b.id_tipo_servicio=tipos_servicios.id_tipo_servicio and titulares.id_titular=procesos.id_titular and titulares.id_cliente=clientes.id_cliente and titulares.id_ente=entes.id_ente and procesos.id_estado_proceso<>14");
...
$q_gastos=("select * from gastos_t_b,procesos where gastos_t_b.id_proceso=procesos.id_proceso and procesos.id_proceso='$proceso' and procesos.id_estado_proceso<>14");
...
<?php echo "$f_proceso[servicio] PRESUPUESTO Num. $proceso" ?>
</td>
</tr>
<tr>
<td colspan=4>
