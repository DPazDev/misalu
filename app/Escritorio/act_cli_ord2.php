	...
	<tr>
		...
		?>
			...
			<tr>
				...
				<td colspan=1 class="tdtitulos"><?php echo formato_montos($totalmonto);?> <input class="campos" type="hidden" name="monto" maxlength=128 size=20 value="<?php echo $totalmonto?>"   ></td>
	</tr>	
...
<tr>		<td colspan=4 class="titulo_seccion">Buscar Cliente Nuevo </td>	</tr>	
	<tr>
		...
		<td colspan=2 class="tdcampos"><a href="#" OnClick="bus_cli_nu();" class="boton">Buscar</a></td>

		
</tr>

</table>
	<div id="bus_cli_nu"></div>
<?php
}
?>
