...
<table class="tabla_cabecera5"  cellpadding=0 cellspacing=0>
     ...
     <tr>
       ...
       <td class="tdcampos" >
          <select id="clienpoliza" class="campos" style="width: 160px;" onchange="CaractPoliza(this.value)">
                              <option value=""></option>
    ...
    <table class="tabla_citas"  cellpadding=0 cellspacing=0>
              ...
              <tr>
                   <td class="tdcampos" >0 - 9</td>
                   <td class="tdcampos" >
                          <select id="edadh1" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@0-9"?>"> <?php echo "$i"?></option>
			          <?php
			            }
			             ?>
			 </select>  
             ...
             <td class="tdcampos" >
                          <select id="edadm1" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@0-9"?>"> <?php echo "$i"?></option>
			          <?php
              ...
              <tr>
                 <td class="tdcampos" colspan="3"><HR></td>
              </tr>
              <tr>
                   <td class="tdcampos" >10 - 19</td>
                   <td class="tdcampos" >
                          <select id="edadh2" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@10-19"?>"> <?php echo "$i"?></option>
			          <?php
			            }
			             ?>
			 </select>  
             ...
             <td class="tdcampos" >
                          <select id="edadm2" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@10-19"?>"> <?php echo "$i"?></option>
			          <?php
              ...
              <tr>
                   <td class="tdcampos" >20 - 29</td>
                   <td class="tdcampos" >
                          <select id="edadh3" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@20-29"?>"> <?php echo "$i"?></option>
			          <?php
			            }
			             ?>
			 </select>  
             ...
             <td class="tdcampos" >
                          <select id="edadm3" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@20-29"?>"> <?php echo "$i"?></option>
			          <?php
              ...
              <tr>
                   <td class="tdcampos" >30 - 39</td>
                   <td class="tdcampos" >
                          <select id="edadh4" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@30-39"?>"> <?php echo "$i"?></option>
			          <?php
			            }
			             ?>
			 </select>  
             ...
             <td class="tdcampos" >
                          <select id="edadm4" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@30-39"?>"> <?php echo "$i"?></option>
			          <?php
              ...
              <tr>
                   <td class="tdcampos" >40 - 49</td>
                   <td class="tdcampos" >
                          <select id="edadh5" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@40-49"?>"> <?php echo "$i"?></option>
			          <?php
			            }
			             ?>
			 </select>  
             ...
             <td class="tdcampos" >
                          <select id="edadm5" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@40-49"?>"> <?php echo "$i"?></option>
			          <?php
              ...
              <tr>
                   <td class="tdcampos" >50 - 54</td>
                   <td class="tdcampos" >
                          <select id="edadh6" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@50-54"?>"> <?php echo "$i"?></option>
			          <?php
			            }
			             ?>
			 </select>  
             ...
             <td class="tdcampos" >
                          <select id="edadm6" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@50-54"?>"> <?php echo "$i"?></option>
			          <?php
              ...
              <tr>
                   <td class="tdcampos" >55 - 59</td>
                   <td class="tdcampos" >
                          <select id="edadh7" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@55-59"?>"> <?php echo "$i"?></option>
			          <?php
			            }
			             ?>
			 </select>  
             ...
             <td class="tdcampos" >
                          <select id="edadm7" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@55-59"?>"> <?php echo "$i"?></option>
			          <?php
              ...
              <tr>
                   <td class="tdcampos" >60 - 69</td>
                   <td class="tdcampos" >
                          <select id="edadh8" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@60-69"?>"> <?php echo "$i"?></option>
			          <?php
			            }
			             ?>
			 </select>  
             ...
             <td class="tdcampos" >
                          <select id="edadm8" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@60-69"?>"> <?php echo "$i"?></option>
			          <?php
              ...
              <tr>
                   <td class="tdcampos" >70 - 79</td>
                   <td class="tdcampos" >
                          <select id="edadh9" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@70-79"?>"> <?php echo "$i"?></option>
			          <?php
			            }
			             ?>
			 </select>  
             ...
             <td class="tdcampos" >
                          <select id="edadm9" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@70-79"?>"> <?php echo "$i"?></option>
			          <?php
              ...
              <tr>
                   <td class="tdcampos" >80 y mayores</td>
                   <td class="tdcampos" >
                          <select id="edadh10" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@80-120"?>"> <?php echo "$i"?></option>
			          <?php
			            }
			             ?>
			 </select>  
             ...
             <td class="tdcampos" >
                          <select id="edadm10" class="campos" style="width: 70px;" >
                              <option value=""></option>
			             <?php  for($i=1;$i<21;$i++){?>
                              <option value="<?php echo "$i@80-120"?>"> <?php echo "$i"?></option>
			          <?php
