...
<td colspan=1 class="datos_cliente">
<?php echo montos_print($elmontonoaprobado) ?> BS. 
</td>
...
<td colspan=1 class="datos_cliente">
<?php echo formato_montos($monto - $elmontonoaprobado) ?> BS. 
</td>
...
<tr>
<td colspan=4 class="datos_cliente">&nbsp;&nbsp;HE RECIBIDO DE <?php echo $_REQUEST[ente]; ?>, POR CONCEPTOS ARRIBA MENCIONADOS, LA CANTIDAD DE: <?php echo formato_montos($monto); ?> Bs.S. <?php echo numeros_a_letras($monto); ?>. 
