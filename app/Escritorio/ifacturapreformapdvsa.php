...
count(gastos_t_b.id_tipo_servicio)
from
gastos_t_b,
tipos_servicios,
                            procesos 
...
gastos_t_b.id_tipo_servicio=tipos_servicios.id_tipo_servicio
group by 
             tipos_servicios.id_tipo_servicio,
tipos_servicios.tipo_servicio order by tipos_servicios.id_tipo_servicio");
$r_gastos_1=ejecutar($q_gastos_1);
...
<?php echo "$f_proceso[servicio] NOTA DE SERVICIO Num. $f_proceso[nu_planilla] Clave: $f_proceso[no_clave]" ?>
</td>
</tr>
<tr>
<td colspan=4>
...
<?php
 ...
 while($f_gastos_1=asignar_a($r_gastos_1,NULL,PGSQL_ASSOC)){
...
<?php echo $f_gastos_1[tipo_servicio] ?>
</td>
<td colspan=1 class="datos_cliente">
...
<td colspan=1 class="datos_cliente">
<?php echo montos_print($montot) ?> BS. 
</td>
...
<tr>
			...
			<td  colspan=2 class="datos_cliente">MONTO TOTAL EXENTO O EXONERADO Bs.S. 
				...
				<td colspan=1 class="datos_cliente"> <?php echo montos_print($montot); echo  $cero;?></td>
			</tr>
				<tr>
                <td  colspan=1 class="datos_cliente">
    		</td>
