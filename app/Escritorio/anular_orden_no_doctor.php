...
$mod_proceso="update procesos set id_estado_proceso='17',fecha_modificado='$fechacreado',hora_modificado='$hora',comentarios='$cooperador' where procesos.id_proceso=$proceso";
$fmod_proceso=ejecutar($mod_proceso); 
...
<tr>		
<td colspan=4 class="titulo_seccion">La Orden  Numero <?php echo $proceso ?> se Anulo por NO ASISTIR EL DOCTOR, con Exito </td>	
</tr>	
