...
$num_filasp=num_filas($r_proceso);
...
and titulares.id_ente=entes.id_ente and estados_clientes.id_estado_cliente>=4 and beneficiarios.id_beneficiario=procesos.id_beneficiario and procesos.id_proceso='$proceso'");
...
<td colspan=3 class="tdcampos">
		...
		<option value=""> Seleccione La Cobertura</option>
		 ...
		 <option value="<?php echo $f_coberturat[id_cobertura_t_b]?>"> <?php echo "$f_coberturat[cualidad]  Cobertura Disponible $f_coberturat[monto_actual] " ?>
                 </option>
                <?php
                }
                ?>
				...
				<?php
				    $url="views01/igastos.php?cedula=$f_cliente[cedula]&id_titular=$f_cliente[id_titular]&titular=$titular&fechainicio=$f_cliente[fecha_inicio_contrato]&fechafinal=$f_cliente[fecha_renovacion_contrato]&id_servicio=$servicio";
						...
						if ($tiposerv==5)
							{
								  $url1="views01/iconpreven.php?cedula=$f_cliente[cedula]&id_titular=$f_cliente[id_titular]&titular=$titular&fechainicio=$f_cliente[fecha_inicio_contrato]&fechafinal=$f_cliente[fecha_renovacion_contrato]&id_servicio=$servicio";
								?>
						...
						if ($tiposerv==11)
							{
								  $url2="views01/iconlentes.php?cedula=$f_cliente[cedula]&id_titular=$f_cliente[id_titular]&titular=$titular&fechainicio=$f_cliente[fecha_inicio_contrato]&fechafinal=$f_cliente[fecha_renovacion_contrato]&id_servicio=$servicio";
								?>
...
<td colspan=3 class="tdcampos">
              ...
              <?php
				    $url="views01/igastos.php?cedula=$f_clienteb[cedula]&id_titular=$f_cliente[id_titular]&titular=$titular&fechainicio=$f_cliente[fecha_inicio_contrato]&fechafinal=$f_cliente[fecha_renovacion_contrato]&id_servicio=$servicio";
                        ?> <a href="<?php echo $url; ?>" title="Relacion de Gastos"  onclick="Modalbox.show(this.href, {title: this.title, width: 800, height: 400, overlayClose: false}); return false;" class="boton">Consultar Gastos</a>
						<?php 
						if ($tiposerv==5)
							{
								  $url1="views01/iconpreven.php?cedula=$f_clienteb[cedula]&id_titular=$f_cliente[id_titular]&titular=$titular&fechainicio=$f_cliente[fecha_inicio_contrato]&fechafinal=$f_cliente[fecha_renovacion_contrato]&id_servicio=$servicio";
								?>
							<a href="<?php echo $url1; ?>" title="Relacion de Consultas Preventivas"  onclick="Modalbox.show(this.href, {title: this.title, width: 800, height: 400, overlayClose: false}); return false;" class="boton">Consultas Preventivas</a>	
						...
						if ($tiposerv==11)
							{
								  $url2="views01/iconlentes.php?cedula=$f_clienteb[cedula]&id_titular=$f_cliente[id_titular]&titular=$titular&fechainicio=$f_cliente[fecha_inicio_contrato]&fechafinal=$f_cliente[fecha_renovacion_contrato]&id_servicio=$servicio";
								?>
							<a href="<?php echo $url2; ?>" title="Relacion de Lentes"  onclick="Modalbox.show(this.href, {title: this.title, width: 800, height: 400, overlayClose: false}); return false;" class="boton">Ordenes de Lentes</a>	
...
<tr> 
		...
		<td>
 <input readonly type="text" size="10" id="dateField1" name="fechar" class="campos" maxlength="10" value=<?php echo $fecharec ?>> 
...
<img src="../public/images/calendar.gif" class="cp_img" alt="Seleccione la Fecha"></a>
	...
	?>
	<tr>
					<td class="tdtitulos">Numero de Presupuesto</td>
              	<td class="tdcampos"><input class="campos" type="text" name="numpre" 
					maxlength=128 size=20 value="0" onkeyUp="return ValNumero(this);"  >
					</td>
 <td class="tdtitulos">Hora Ingreso</td>
                <td class="tdcampos"><input class="campos" type="text" name="horac"
                                        maxlength=128 size=15 value=""   ></td>
	</tr>
	
	
		<?php 
}
	if (($tiposerv==9) || ($tiposerv==13) || ($tiposerv==20) || ($tiposerv==21)) {
	?>
...
<tr>
		...
		<tr>
			<td colspan=1 class="tdtitulos">Comentario</td>
              	<td colspan=3 class="tdcampos"><textarea name="comenope" cols=72 rows=2 class="campos"><?php echo $comenope?></textarea></td>
	</tr>	
<tr>
...
<?php if ($tiposerv==20 || $tiposerv==21)
{
?>
			<input class="campos" type="text" id="valor_<?php echo $i?>"  
name="valor" maxlength=128 size=10 value="<?php echo $f_baremoe[hono_privados]?>"   >
<?php 
}
else
{
...
<td class="tdtitulos">* Monto Total</td>
	...
	if (($tiposerv<>6 and $servicio==4) || $tiposerv==14 || $tiposerv==15 || $tiposerv==16 || $tiposerv==17 || $tiposerv==19)
	{
...
?>
   ...
   <tr>
				...
				<td colspan=1 class="tdtitulos">* Honorarios Medicos</td><input class="campos" type="hidden" name="numpre" 
					maxlength=128 size=20 value="0"   >
              	<td colspan=1 class="tdcampos"><input class="campos" type="text" id="honorarios_1" name="montoh" 
					maxlength=128 size=20 value="0"   ><input class="campos" style="visibility:hidden" type="checkbox"  <?php echo $ban ?> id="check_100"name="checkl" maxlength=128 size=20 value="">
					</td>
				<td colspan=1 class="tdtitulos">* Gastos Clinicos</td>
              	<td colspan=1 class="tdcampos"><input class="campos" type="text" id="honorarios_2" name="montog" maxlength=128 size=20 value="0"   ><input class="campos"  style="visibility:hidden" type="checkbox"  <?php echo $ban ?>  id="check_200" name="checkl" maxlength=128 size=20 value=""></td>

	</tr>		
	<tr>
		 
				<td colspan=1 class="tdtitulos">* Otros Gastos</td>
              	<td colspan=1 class="tdcampos"><input class="campos" type="text" id="honorarios_3"  name="montoo" maxlength=128 size=20 value="0"   ><input class="campos" style="visibility:hidden" type="checkbox" <?php echo $ban ?>   id="check_300" name="checkl" maxlength=128 size=20 value="">
					</td>
				<td colspan=1><a href="javascript: sumar(this);" class="boton">      Calcular Monto</a></td>
	...
	<tr>		
		...
		<tr>
			<td colspan=1 class="tdtitulos">Comentario</td>
              	<td colspan=3 class="tdcampos"><textarea name="comenope" cols=72 rows=1 class="campos"><?php echo $comenope?></textarea><td class="tdcampos"><input class="campos" type="hidden" name="horac" 	maxlength=128 size=20 value=""   ></td>
	</tr>		
	<tr>
	<td  class="tdtitulos"></td>
	</tr>
...
<tr>
				<td  colspan=1  class="tdtitulos">* Numero de Presupuesto</td>
              	<td  colspan=3  class="tdcampos"><input class="campos" type="hidden" name="numpre" maxlength=128 size=15 value="<?php echo $numpre?>"   ><?php echo $numpre?><input class="campos" type="hidden" name="tp" maxlength=128 size=15 value="<?php echo $tiposerv?>"></td>
		</tr>
<tr>
				<td  colspan=1  class="tdtitulos">* Cuadro Medico</td>
              	<td  colspan=3  class="tdcampos"><input class="campos" type="text" name="enfermedad" maxlength=128 size=63 value=""   ></td>
...
<tr>
				<td  colspan=1  class="tdtitulos">* Cuadro Medico</td>
              	<td  colspan=3  class="tdcampos"><input class="campos" type="text" name="enfermedad" maxlength=128 size=63 value=""   ><input class="campos" type="hidden" name="numpre" maxlength=128 size=15 value="0"   >
				<input class="campos" type="hidden" name="tp" maxlength=128 size=15 value="0"   >
				</td>
		</tr>	
	<tr>
			<td colspan=1 class="tdtitulos">Comentario</td>
              	<td colspan=3 class="tdcampos"><textarea name="comenope" cols=72 rows=1 class="campos"><?php echo $f_proceso[comentarios]?></textarea><td class="tdcampos"><input class="campos" type="hidden" name="horac" 
					maxlength=128 size=20 value=""   ></td>
	</tr>		
	<tr>
		<td  class="tdtitulos">Nombre 
...
$i++;
$q_clientet=("select clientes.id_cliente,clientes.nombres,clientes.apellidos,clientes.cedula,
estados_clientes.estado_cliente,titulares.id_titular,titulares.id_ente,entes.nombre,entes.fecha_inicio_contrato,entes.fecha_renovacion_contrato,entes.fecha_inicio_contratob,entes.fecha_renovacion_contratob 
from clientes,titulares,estados_t_b,estados_clientes,entes
                where titulares.id_titular=$f_clienteb[id_titular] and clientes.id_cliente=titulares.id_cliente and 
titulares.id_titular=estados_t_b.id_titular and estados_t_b.id_beneficiario=0 and 
estados_t_b.id_estado_cliente=estados_clientes.id_estado_cliente and titulares.id_ente=entes.id_ente");
...
<td colspan=3 class="tdcampos">
                ...
                ?>
				  ...
				  <?php
				    $url="views01/igastos.php?cedula=$f_clienteb[cedula]&id_titular=$f_clientet[id_titular]&titular=$titular&fechainicio=$f_clientet[fecha_inicio_contrato]&fechafinal=$f_clientet[fecha_renovacion_contrato]&id_servicio=$servicio";
                        ?> <a href="<?php echo $url; ?>" title="Relacion de Gastos"  onclick="Modalbox.show(this.href, {title: this.title, width: 800, height: 400, overlayClose: false}); return false;" class="boton">Consultar Gastos</a>
						<?php 
						if ($tiposerv==5)
							{
								  $url1="views01/iconpreven.php?cedula=$f_clienteb[cedula]&id_titular=$f_clientet[id_titular]&titular=$titular&fechainicio=$f_clientet[fecha_inicio_contrato]&fechafinal=$f_clientet[fecha_renovacion_contrato]&id_servicio=$servicio";
								?>
							<a href="<?php echo $url1; ?>" title="Relacion de Consultas Preventivas"  onclick="Modalbox.show(this.href, {title: this.title, width: 800, height: 400, overlayClose: false}); return false;" class="boton">Consultas Preventivas</a>	
						...
						if ($tiposerv==11)
							{
								  $url2="views01/iconlentes.php?cedula=$f_clienteb[cedula]&id_titular=$f_clientet[id_titular]&titular=$titular&fechainicio=$f_clientet[fecha_inicio_contrato]&fechafinal=$f_clientet[fecha_renovacion_contrato]&id_servicio=$servicio";
								?>
							<a href="<?php echo $url2; ?>" title="Relacion de Lentes"  onclick="Modalbox.show(this.href, {title: this.title, width: 800, height: 400, overlayClose: false}); return false;" class="boton">Ordenes de Lentes</a>	
						...
						<?php
							...
							if ($servicio==1)
							{
								$url3="views01/farmaext3.php?tipoc=B&idbusq=$f_clienteb[id_beneficiario]&tipooper=TC";
						?>
