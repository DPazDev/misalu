...
$q_noaprovo=("select sum(cast(gastos_t_b.monto_reserva as double precision)) from titulares,gastos_t_b,tbl_procesos_claves,procesos where tbl_procesos_claves.id_proceso=procesos.id_proceso and tbl_procesos_claves.id_factura=$f_factura[id_factura] and procesos.id_titular=titulares.id_titular and gastos_t_b.id_proceso=procesos.id_proceso and gastos_t_b.monto_aceptado>'0' and (gastos_t_b.id_tipo_servicio=27 or gastos_t_b.id_tipo_servicio=28) ;  ");

$r_qnoaprovo=ejecutar($q_noaprovo);
$datmontonoapo=assoc_a($r_qnoaprovo);
$elmontonoaprobado=$datmontonoapo[sum];
//echo $elmontonoaprobado;
?>
<html>
<head>
<title></title>
...
<table width="100%" cellspacing=0 cellpadding=0 border=0>
        <tr>
	         <td width="80%" align="left">Nombre o razon socialxxx: <?php echo $f_cliente[nombre];?>
			</tr>
		 <tr>
		 <td align="left">RIF: <?php echo $f_cliente[rif]; ?></td>
	 </tr>
...
<tr>
				<td  valign="top" align="right">MONTO NO APROBADO Bs.S.
    		</td>
        ...
        else
        {
            ?>
				...
				<td width="200" valign="top" align="right"> <?php echo montos_print(abs($total));  echo  $cero;?></td>
			</tr>
...
<?php
  ...
  if(($serie==4) || ($serie==6) || ($serie==8) || ($serie==5) || ($serie==7) || ($serie==3) ){ 
?>
 <br> 
<div align="center">
<table width="100%" cellspacing=0 cellpadding=0 border=0><tr>
		...
		<td width="70%" valign="top"></td>
		<td width="30%" style="padding-top: 15px;height: 30px;text-align: right; font-size: 08pt;" valign="top"><b>CONTRIBUYENTE FORMAL</b></td>
	</tr>

	<tr>
		<td width="70%" valign="top"></td>
		<td width="30%" style="padding-top: 15px;height: 30px;text-align: right; font-size: 08pt;" valign="top"><b>Serie <?php echo $f_factura['nomenclatura']; ?></b> <b>No. de factura 00<?php echo $no_factura; ?></b></td>
	</tr>
		<tr>
		<td width="70%" valign="top"><b> <?php if ($f_factura[codigosap]>0){ echo "Codigo Sap $f_factura[codigosap]";} ?> </b></td>
		 ...
		 if ($f_cliente[id_recibo_contrato]>0)
	{
		...
		else
		{
			while($f_gasto=asignar_a($r_gasto)){
				...
				?>
			<tr>
		<td width="70%" align="left" style="font-size: 07pt"><?php echo "$f_gasto[nombre] ($f_gasto[descripcion] )";  ?></td>
			<td width="10%" align="left"></td>
...
<tr>
				<td  valign="top" align="right" style="font-size: 07pt">MONTO NO APROBADO Bs.S.
    		</td>
