...
function MostrarcaractereMontos(str) {
  alert(str)
}
...
<fieldset id='Nuevo-Servicios' class="tdtitulos contenedor-servicios" >
    <legend class="tdtitulos"> FORMULARIO DE SERVICIO NUEVO</legend>
      ...
      <Div id='ns-con-direcion'>
          ...
          <TEXTAREA COLS=25 ROWS=5 id="dprop" class="campos"></TEXTAREA>
      </div>
     ...
     <Div id='ns-con-nomina'>
          <label for="pno"  class="tdtitulos" >Es proveedor nomina:</label><br>
              <span><span class="checkbox-JASoft"> <input type="checkbox" name='psi' checked='checked' id="pno" value=1 ><label for="pno"  title='indica si es un proveedor que esta por nomina' >Si</label></span></span>
    ...
    <DIV id='ns-con-laboral' >
                    ...
                    <SPAN class="row-titulo">D&iacute;as laborales:</SPAN>
                     <span>Lunes<span class="checkbox-JASoft"><input type="checkbox" id="lunes1" onchange="idenput=this.id;dia=$F(idenput);idgemelo='estuido'+idenput; if(dia==null || dia==''){gemelo=$(idgemelo).disabled=true;$(idgemelo).focus();}else{gemelo=$(idgemelo).disabled=false;$(idgemelo).focus();}" value='1'><label for="lunes1"  title='Has Click para activar el horario' >Lunes</label></span></span>
                     <span>Martes<span class="checkbox-JASoft"><input type="checkbox" id="martes1" onchange="idenput=this.id;dia=$F(idenput);idgemelo='estuido'+idenput; if(dia==null || dia==''){gemelo=$(idgemelo).disabled=true;}else{gemelo=$(idgemelo).disabled=false;$(idgemelo).focus();}" value='1'>'<label for="martes1" title='Has Click para activar el horario'>Martes</label></span></span>
                     <span>Mi&eacute;rcoles<span class="checkbox-JASoft"><input type="checkbox" id="miercoles1" onchange="idenput=this.id;dia=$F(idenput);idgemelo='estuido'+idenput; if(dia==null || dia==''){gemelo=$(idgemelo).disabled=true;}else{gemelo=$(idgemelo).disabled=false;$(idgemelo).focus();}"value='1'><label for="miercoles1" title='Has Click para activar el horario'>Miércoles</label></span></span>
                     <span>Jueves<span class="checkbox-JASoft"><input type="checkbox" id="jueves1" onchange="idenput=this.id;dia=$F(idenput);idgemelo='estuido'+idenput; if(dia==null || dia==''){gemelo=$(idgemelo).disabled=true;}else{gemelo=$(idgemelo).disabled=false;$(idgemelo).focus();}" value='1'><label for="jueves1" title='Has Click para activar el horario'>Jueves</label></span></span>
                     <span>Viernes<span class="checkbox-JASoft"><input type="checkbox" id="viernes1" onchange="idenput=this.id;dia=$F(idenput);idgemelo='estuido'+idenput; if(dia==null || dia==''){gemelo=$(idgemelo).disabled=true;}else{gemelo=$(idgemelo).disabled=false;$(idgemelo).focus();}" value='1'><label for="viernes1" title='Has Click para activar el horario'>Viernes</label></span></span>
           			     <span>S&aacute;bado<span class="checkbox-JASoft"><input type="checkbox" id="sabado1" onchange="idenput=this.id;dia=$F(idenput);idgemelo='estuido'+idenput; if(dia==null || dia==''){gemelo=$(idgemelo).disabled=true;}else{gemelo=$(idgemelo).disabled=false;$(idgemelo).focus();}" value='1'><label for="sabado1" title='Has Click para activar el horario'>S&aacute;bado</label></span></span>
           			     <span>Domingo<span class="checkbox-JASoft"><input type="checkbox" id="domingo1" onchange="idenput=this.id;dia=$F(idenput);idgemelo='estuido'+idenput; if(dia==null || dia==''){gemelo=$(idgemelo).disabled=true;}else{gemelo=$(idgemelo).disabled=false;$(idgemelo).focus();}" value='1'><label for="domingo1" title='Has Click para activar el horario'>Domingo</label></span></span>
      ...
      <DIV class="tdtitulos" id='ns-con-activos' >
         ...
         <span id='ns-con-controles'>
                 <input type="hidden" id="pce" value="<?php echo $cepnu;?>">
                 <input type="hidden" id="nombr" value="<?php echo $nopnui;?>">
                 <input type="hidden" id="pape" value="<?php echo $apenu;?>">
                 <input type="hidden" id="pcore" value="<?php echo $corenu;?>">
                 <input type="hidden" id="pte" value="<?php echo $tefnu;?>">
         </span>

         <DIV id='ns-con-envio'>
          <span title="Guardar servicio"><label class="boton" style="cursor:pointer" onclick="guaservi1()" >Guardar servicio</label></span>
         </DIV>
