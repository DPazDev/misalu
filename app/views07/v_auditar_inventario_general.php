...
$r_dependencia=pg_query("select * from tbl_dependencias order by dependencia");
?>
...
function enviar(){
		...
		document.inventario_almacen.submit();
}

-->
</script>

<form action="v_auditar_inventario_general2.php" method="POST" name="inventario_almacen" target="_blank">
<table <?php echo propiedades_tabla; ?>>
	<tr>		<td colspan=2 align="center" class="titulo_seccion">Modulo para ver Auditar Inventario General</td>	</tr>
...
<tr>
	...
	<?php
	while($f_dependencia=pg_fetch_array($r_dependencia, NULL, PGSQL_ASSOC))
