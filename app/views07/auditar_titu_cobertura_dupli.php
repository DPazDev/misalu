...
<tr>		<td colspan=4 class="titulo_seccion">Auditar estados_t_b titulares duplicados</td>	</tr>	
 <tr> 
	...
	<tr> 
	  ...
	  <td class="tdtitulos" colspan="1"><?php echo $f_titu_cober_dupl[id_titular]?></td>
		...
		$q_titu_cober_dupl2= "select 
											...
											from 
													coberturas_t_b
											where 
													coberturas_t_b.id_titular=$f_titu_cober_dupl[id_titular] and
	  ...
	  <td class="tdtitulos" colspan="1"><?php echo $f_titu_cober_dupl2[id_titular]?></td>
		...
		<?php
				...
				$q_titu_cober_dupl3= "select 
											...
											where 
													...
													coberturas_t_b.id_titular='$f_titu_cober_dupl2[id_titular]' and
