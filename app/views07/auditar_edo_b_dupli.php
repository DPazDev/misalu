...
$q_edo_dupl= "select 
								...
								count(estados_t_b.id_beneficiario) 
						from 
								estados_T_b 
						where 
...
<tr>		<td colspan=4 class="titulo_seccion">Auditar estados_t_b titulares duplicados</td>	</tr>	
 <tr> 
	...
	<tr> 
	  ...
	  <td class="tdtitulos" colspan="1"></td>
		 <td class="tdcampos"  colspan="1"><?php echo $f_edo_dupl[id_beneficiario]?> </td>
		...
		$q_edo_dupl2= "select 
											...
											where 
													...
													estados_t_b.id_beneficiario=$f_edo_dupl[id_beneficiario]
											";
	  ...
	  <td class="tdtitulos" colspan="1"></td>
		...
		<td class="tdcampos"  colspan="1"><?php echo $f_edo_dupl2[id_beneficiario]?> </td> 
</tr>
		...
		<?php
			$q_eli_titu_edo=("delete  from 
										...
										where
												estados_t_b.id_beneficiario>'0' and
												estados_t_b.id_beneficiario=$f_edo_dupl2[id_beneficiario] and
