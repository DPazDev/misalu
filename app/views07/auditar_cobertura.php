...
<tr>		<td colspan=4 class="titulo_seccion">Auditar Coberturas de Usuarios Comparando sus Gastos con la Fecha de Vigencia de la Cuadro Recibo de Prima</td>	</tr>	
	...
	<tr> 
	  ...
	  <td class="tdtitulos" colspan="1">Seleccione Tipo de Ente:</td>
         ...
         <select class="campos"  style="width: 200px;"  id="tipo_ente" name="tipo_ente" onchange="bus_ent(5)" >
