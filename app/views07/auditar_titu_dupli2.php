...
?>
	  ...
	  <td class="tdcamposr" colspan="1"><?php echo $j?></td>
		...
		<td class="tdcamposr"  colspan="1">contador </td>
		<td class="tdcamposr"  colspan="1"> Proceso</td> 
		<td class="tdcamposr" colspan="1">id_beneficiario</td>
		</tr>
		<?php
		...
		<td class="tdcamposr" colspan="1"><?php echo $f_gasto_p[id_cliente]?> <?php echo "$newtitu ---- $newidcobertura"?></td>
		</tr>
...
$q_eli_titu_b=("delete  from 
												beneficiarios
										where
												beneficiarios.id_titular='$f_titu_d[id_titular]'");
$r_eli_titu_b=ejecutar($q_eli_titu_b);
		*/
		}
		}
		?>
