...
<select style="width: 100px;" id="tiposerv_<?php echo $i?>" name="tiposerv" class="campos" >
			...
			<?php $q_especialidad=("select * from especialidades_medicas order by especialidad_medica");
...
<td  class="tdtitulos">
		<select  id="tiposerv_<?php echo $i?>" OnChange="multiplicar(this);" name="tiposerv" class="campos" >
...
<select style="width: 100px;" id="tiposerv_<?php echo $i?>" name="tiposerv" class="campos" >
				...
				<option value=""> GASTOS EMERGENCIAS</option>
...
if (($tiposerv==6 and $servicio==4) || ($tiposerv==8 and $servicio==6)) {
