...
?>
 <table class="tabla_cabecera3"  cellpadding=0 cellspacing=0>
     <tr> 
         <td colspan=4 class="titulo_seccion">Activar Usuario</td>  
     </tr>
     <tr>
	     <td class="tdtitulos">* C&eacute;dula</td>
         <td class="tdcampos"><input class="campos" type="text" name="cedulclien" id="cedulclien"   ></td> 
         <td title="Buscar cliente"><label id="titularboton" class="boton" style="cursor:pointer" onclick="buscliindi()" >Buscar</label>
