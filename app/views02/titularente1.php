     ...
     <tr> 
      ...
      <table class="tabla_cabecera5"  cellpadding=0 cellspacing=0>
        <tr>
             ...
             <td class="tdtitulos">Selecione el nuevo ente:</td>
                 <td class="tdcampos">
                    <select id="nuevente" class="campos"  style="width: 230px;" onChange="verpoliza1()">
			       <option value=""></option>
                    <?php  
			         while($ventesnue=asignar_a($relosnuente,NULL,PGSQL_ASSOC)){
				    ?>
					<option value="<?php echo $ventesnue[id_ente]?>"> <?php echo "$ventesnue[nombre]"?></option>
			      <?}?>
		        </select>  
             </td>
        </tr>
        <tr>
             <td class="tdtitulos">Pasar gastos:</td>
             <td class="tdcampos">
                  <input type="radio" name="pasg1" id="pagos1" value="1">Si
                  <input type="radio" name="pasg1" id="pagos2" value="2" checked>No
             </td>
             <td class="tdtitulos">Trasladar beneficiarios:</td>
             <td class="tdcampos">
                  <input type="radio" name="pasg2" id="benef1" value="1" checked>Si
                  <input type="radio" name="pasg2" id="benef2" value="2" >No
             </td>            
        </tr>
        <tr>
			    <td class="tdtitulos">Comentario:</td>  
				<td class="tdcampos"><TEXTAREA COLS=40 ROWS=7 id="comentitu" class="campos"></TEXTAREA></td>  				
		</tr>
        </table>
        <div id='losente'></div>
        ...
        <table class="tabla_citas"  cellpadding=0 cellspacing=0>
        <tr>
              <td><label title="Cambiar titular a ente" id="titularente" class="boton" style="cursor:pointer" onclick="titucambiente()" >Procesar Cambio</label></td>                
      </tr>
     </table>
