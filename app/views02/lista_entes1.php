...
if(empty($laletra)){
    $losentes=("select entes.nombre,entes.rif,entes.nombre_contacto,entes.telefonos_contacto,entes.fecha_creado,entes.codente 
...
<div id='losentesca'>
 <table class="tabla_cabecera3"  cellpadding=0 cellspacing=0>
     <tr> 
         ...
         <td class="titulo_seccion"><label  title="Regresar al modulo Ente" class="boton" style="cursor:pointer" onclick="reg_empresas()" >Regresar</label></td>
	</tr>
    <tr> 
    ...
    <?
        ...
        while($losenteson=asignar_a($replosentes,NULL,PGSQL_ASSOC)){?>
            <tr>
                    ...
                    <td class="tdcampos"><?echo $losenteson['nombre'];?></td>
