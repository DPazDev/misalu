...
?>
 <form method="get" onsubmit="return false;" name="regclien" id="regclien">
   <table class="tabla_cabecera3"  cellpadding=0 cellspacing=0>
     <tr> 
         <td colspan=4 class="titulo_seccion">Reimprimir Anulaci&oacute;n de Contrato</td>  
     </tr>
     <tr>
	 <td class="tdtitulos">* C&eacute;dula del titular</td>
         ...
         <td class="tdcampos" title="Registrar cliente al sistema"><label class="boton" style="cursor:pointer" onclick="reimprianulacion()" >Buscar</label>
