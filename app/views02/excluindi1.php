...
$estclien=("select estados_clientes.id_estado_cliente,estados_clientes.estado_cliente 
               ...
               where (id_estado_cliente=5 or id_estado_cliente=1 or id_estado_cliente=4 or id_estado_cliente=8 or id_estado_cliente=9 or id_estado_cliente=7 or id_estado_cliente=10) 
     ...
     <table class="tabla_cabecera5"  cellpadding=0 cellspacing=0>
      ...
      <td class="tdcampos">
       <select id="estaclienot" class="campos" >
        ...
        <tr>
			    <td class="tdtitulos">Comentario:</td>  
				<td class="tdcampos"><TEXTAREA COLS=40 ROWS=7 id="comentituotb" class="campos"></TEXTAREA></td>  				
		</tr>
        </table>
        <div id='losente'></div>
        <input type="hidden" id="cedulclien" value="<?echo $ceduclien?>">
