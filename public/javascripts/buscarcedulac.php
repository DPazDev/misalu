...
/* **** busco si es titular **** */
$q_cliente=("select clientes.id_cliente,clientes.nombres,clientes.apellidos,clientes.cedula,clientes.telefono_hab,clientes.telefono_otro,estados_clientes.estado_cliente,titulares.id_titular,titulares.id_ente,entes.nombre from clientes,titulares,estados_t_b,estados_clientes,entes
...
if ($num_filas == 0) { 
$q_clienteb=("select clientes.id_cliente,clientes.telefono_hab,clientes.telefono_otro,clientes.nombres,clientes.apellidos,clientes.cedula,estados_clientes.estado_cliente,
...
coberturas_t_b.id_titular='$f_cliente[id_titular]'  and coberturas_t_b.id_organo<=1 and propiedades_poliza.cualidad='GASTOS AMBULATORIOS' order by propiedades_poliza.cualidad");
...
coberturas_t_b.id_titular='$f_clientet[id_titular]' and coberturas_t_b.id_organo<=1 and propiedades_poliza.cualidad='GASTOS AMBULATORIOS' order by propiedades_poliza.cualidad");
...
<td colspan=2 class="tdcampos">
 ...
 s_p_proveedores.id_sucursal=sucursales.id_sucursal and                 especialidades_medicas.id_especialidad_medica=s_p_proveedores.id_especialidad
