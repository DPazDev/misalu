...
function CliCedula(cedula,titu){
 ...
 function edipro(idpp,act,cedu){
	 new Ajax.Updater( act, 
     "views03/datprovee.php", 
     { 
         method:'post', 
	 asynchronous: true,
	 postBody: 'elpp='+idpp+'&lace='+cedu,
     });
}
...
function gucprove(){
	...
	new Ajax.Request("views03/guardp.php",
  {
        method: 'post',
	asynchronous: true,
	postBody: 'ci1='+$F('ciu')+'&es1='+$F('esme')+'&dip1='+$F('dpro')+'&te1='+$F('tel1')+'&ser1='+
                  $F('servmedico')+'&ced1='+$F('cedulpro')+'&idp1='+$F('idpr')+
				  '&com1='+$F('coment')+'&h1='+$F('hop')+'&tipsucur='+$F('lasucur')+'&pv1='+$F('pvn')+'&lanuce='+var1+
				  '&llunes='+$F('lunes1')+'&lmarte='+$F('martes1')+'&lmier='+$F('miercoles1')+'&ljuev='+$F('jueves1')+
				  '&lviern='+$F('viernes1')+'&lsaba='+$F('sabado1')+'&ldomi='+$F('domingo1')+'&opciacti='+opcion+
                                  '&elnom='+$F('nombre1m')+'&elapell='+$F('apellido1m')+'&provinex='+provinex,
  ...
  new Ajax.Request("views03/servin.php",
      {
       method: 'post',
       asynchronous: true,
       postBody: 'cedupp='+$F('cedpnu')+'&nopnu='+$F('nompnue')+'&apenu='+$F('appepnu')+'&cornu='+$F('correpnu')+'&tnu='+$F('telnu'),
       onComplete: mnsPROVa
     });
}
  ...
  if(act1==1){
   ...
   if(varciudad<=0){
    ...
    postBody: 'pcen='+$F('pce')+'&pnbpnom='+$F('nombr')+'&papnu='+$F('pape')+'&pcorenu='+$F('pcore')+'&ptenu='+$F('pte')+
			  ...
			  '&rvierne='+$('viernes1')+'&rsabad='+$F('sabado1')+'&rdomin='+$F('domingo1')+'&estacti='+opcion+'&claspiex='+provinex,
    onComplete: mnsPROVa
  });
                }
            }
...
if ((a==2)||(b==3)){
  ...
  new Ajax.Request("views03/clifin.php",  
      {            
           method: 'post',
           asynchronous: true,
	   postBody: 'rifcf='+$F('elrif')+'&prclinomb='+$F('fnoclin')+'&prclitelef='+$F('ftelcli')+'&fifax='+$F('faxclif')+
		     '&fpw='+$F('pagcli')+'&fdirec='+$F('dircli')+'&fnit='+$F('nitcli')+'&corecl='+$F('correcli')+
                     ...
                     '&rifanombre='+$F('cherif')+'&opciacti='+opcion+'&actprov='+provinex,
...
function finalmodif(){
  ...
  new Ajax.Request("views03/camclie.php",
  {
    method: 'post',
    asynchronous: true,
    postBody: 'verif='+$F('rifve')+'&ricamb='+$F('nvrif')+'&nitcamb='+$F('nvnit')+'&nomcamb='+$F('nvnomb')+'&dircamb='+$F('nvdircli')+
...
function MedGUAR(req){
	$('noexistemed').innerHTML=req.responseText;
	        ...
	        new Ajax.Request("views05/lafacturafinal.php",
                                   {
                                       method:'post',
                                       asynchronous: true,
                                       postBody: 'numfact='+varnumfactura+'&pedidoid='+varidpedido+'&eliva='+variva+
				       '&elaumento='+varaumento+'&losidpro='+$A(arridinsumos)+'&lascandes='+$A(arrcandesp)+        
				       '&lospreprove='+$A(arrpreprove)+'&losqtiva='+$A(arriva)+
				        '&losqtiaumento='+$A(arraumento)+'&depenid='+vardepenid+'&lasfechaven='+$A(arrfechaven)+
...
function Guardarti(){
     ...
     if(Field.present('nombarti')==false){
       alert("El nombre del art\u00edculo es necesario");
     }else{
		 if(vargrupoarti<=0){
			 alert("El grupo del art\u00edculo es necesario");
			}else{
		   ...
		   if(varidpro<=0){  
			   alert('Debe seleccionar un proveedor');   
					...
					new Ajax.Updater('clientes', 'views01/emerhospita1.php', {
							...
							cobToB: lacobert, tiposervi: vartiposervi}
							});	
                                                }
		         }
		}
...
function anularfarma(proceso,tipo){
      if (confirm("Realmente desea eliminar la orden "+proceso)) {
          new Ajax.Updater('farmaelim', 'views01/elifarmaexp.php', {
                     parameters: {elproceso: proceso,elopera: tipo}
                  });
...
function guardarpoliza(){
	  ...
	  if((varnuevpoliza=='') || (vardescpoliza=='') || (varramo=='') ){
		alert('Todos los campos son necesarios!!!');
	       ...
	       parameters: {lapoliza: varnuevpoliza, ladescripoliza: vardescpoliza, elramo: varramo, 
...
function guardar_nueva_propoliza(){
	...
	alert('La propiedad se ha registrado exitosamente!!!');
...
function guardaprimas(){
  ...
  descrprima=$F('descriprima');
  edadini1=$F('edadinicio');
  edadfin1=$F('edadfin');
  lprimanual=$F('primaunual');
  lprimsemes=$F('primsemest');
  lprimtri=$F('primtrimes');
  lprimmens=$F('primmes');
  laidpoliza=$F('elidpoliza'); 
   if((Field.present('elparentesco')==false)){
     ...
     if((Field.present('primaunual')==false)&&(Field.present('primsemest')==false)
         &&(Field.present('primtrimes')==false)&&(Field.present('primmes')==false)){
           ...
           alert('El campo ciudad es necesario!!!');  
             ...
             if((Field.present('cliendirr1')==false)){
              alert('El campo direcci\u00f3n es necesario!!!');  
	            ...
	            parameters: {lacedula: varcedula, lanombre: varnombre, laapelli: varapellido, lagenero: vargenero, latelefono: varteleha,
...
function gucprovefiscal(){
  ...
  tidper=$F('idpepro');
      new Ajax.Updater('fiscalguardado', 'views03/datosficales1.php', {
	       parameters: {pcedula: tcedula, pnombre: tnombre, papell: tapellido,pche: tchenom, prif: trifche,pdir: tdiche,pridp: tidper},   
	       onCreate: function(response) {
               a= Ajax.activeRequestCount;
               if(a>=0)
	         $('spinnerP1' ).show(); 
...
function editarbasicos(){
  ...
  new Ajax.Updater('repclien', 'views01/datosbasico2.php', {
	       parameters: {elidclien:varidcliente,lacedula: varcedula,elnombr: varnombre, elapelli: varapelli,tehab: vartele1, tecelu: vartele2, ladirecc:  vardirecc},   
	       onCreate: function(response) {
               a= Ajax.activeRequestCount;
               if(a>=0)
	         $('spinnerP1' ).show(); 
	...
	varclienfinal=0;   
     ...
     new Ajax.Updater('cotiindi', 'views01/clienindividual1rc.php', {
	            parameters: {cedurif: varcedrif, cnombre: varnombr, capellido: varnapelli, ctelef: vartelefono, cemail: varemail, cpoli: varpoliza,
                    edh1:varedho1,edh2:varedho2,edh3:varedho3,edh4:varedho4,edh5:varedho5,edh6:varedho6,edh7:varedho7,edh8:varedho8,edh9:varedho9,edh10:varedho10,
                    edm1:varedmu1,edm2:varedmu2,edm3:varedmu3,edm4:varedmu4,edm5:varedmu5,edm6:varedmu6,edm7:varedmu7,edm8:varedmu8,edm9:varedmu9,edm10:varedmu10,
                    maternid:varmaterni,edaclien:varedadti,iniclien:varinicial,cuotclien:varcuotas,elgero:vargenero,clienfin:varclienfinal
        },   
	            onCreate: function(response) {
                    a= Ajax.activeRequestCount;
                    if(a>=0)
...
function guardcontrato(){
    ...
    for(i=1;i<varcuanthijos;i++){
         ...
         cedulaben=$F('cedul'+i); 
         if(cedulaben==''){
			 alert("El campo C\u00e9dula en los beneficiario es necesario!!");
			 problema=1;
		 }else{	 
			 if(cedulaben==varcedclien){
				 alert("La C\u00e9dula de un beneficiario no puede ser igual a la del titular!!");
				 problema=1;
			 }else{
				 if(Field.present('fecha'+i)==false){
					 alert("La fecha de nacimiento del beneficiario es necesaria!!");
				     problema=1;
				 }else{
                                  if(Field.present('parent'+i)==false){
					 alert("El parentesco del beneficiario es necesario!!");
				     problema=1;
                                  }else{
           ...
           if(apunta==1){
             arreglo=elnombreben+','+elapelleben+','+nacifecben+','+parentben+','+generoben+','+cedulaben;
           }else{
               arreglo=arreglo+','+elnombreben+','+elapelleben+','+nacifecben+','+parentben+','+generoben+','+cedulaben;  
             }
           apunta=apunta+1;
	              }
	             }
	...
	for(z=1;z<varcuanthijos;z++){
		...
		alert("Los beneficiarios no pueden tener C\u00e9dulas iguales!!");
		problema=1;
		break;	
		}
     ...
     new Ajax.Request("views01/cargacotiza1.php",
	        ...
	        method:'post',
	        asynchronous: true,
	        postBody: 'arreglo='+arreglo+'&frenofami='+apunta+'&cedulatitu='+varcedclien+'&nombtitu='+varnomtitular+'&apelltitu='+varapelltitular+
                          '&fechinclutitu='+varfinclu+'&ciudadtitu='+varciudatitu+'&directitu='+vardiretitu+'&comenttitu='+varcomenttitu+
                          '&cotipoli='+varcotizacititu+'&matertitusi='+varmatersititu+'&matertituno='+varmaternotitu+'&maternoben='+varotramatbeno+
                          '&matersiben='+varotramatbesi+'&inicontrato='+variniciocontrato+'&fincontrato='+varfindocontrato+
                          '&estadotitu='+varestadotitu+'&fechanactitu='+varfechnacititu+'&generotitu='+vartitugenero+'&cotizacion='+varcomision+
                          '&elidcoti='+varcotifin+'&sudtitu='+varsubdivi,
                 onCreate: function(response) {
                    a= Ajax.activeRequestCount;
                    if(a>=0)
	             $('spinnerP1').show(); 
...
function mostraCarga(req){
  $('finalcontrato').show();
  $('finalcontrato').innerHTML=req.responseText;
  $('spinnerP1').hide();  
}
...
function cuadroreciboR(numtitular,numcontrato,numrecibo,numente,numpoliza){
  a="Original Cliente";
  b="Copia Administrativa";
  c="Copia Intermediario";
  d="Copia Operativa";
  for(i=1;i<=4;i++){
   ...
   if(i==4){
    ...
    url='views01/impcuadrorecibo1.php?titular='+numtitular+'&contrato='+numcontrato+'&recibo='+numrecibo+'&elente='+numente+'&lapoliza='+numpoliza+'&texo='+variable;
    imprimir(url);
...
function verbenfcontrato(bnombre,bapelli,bfechana,ndiv){
...
function RenovaContrato(eldiv,fecha1,fecha2,cuantos,ntitular,nbenefi,poliza,lapoliqtiene,numcontrato){
 contraini=$F(fecha1);
 contrafin=$F(fecha2);
 nudtitu=ntitular;
 cuanbeni=nbenefi;
 polizasele=$F(poliza);
 titupoliza=lapoliqtiene;
 nbenefi=nbenefi-1;
 if(ntitular<=0){
	 ntitular=1;
 }
 ...
 a=1;	 
 for(i=ntitular;i<=nbenefi;i++){
 	 estaclientes=document.getElementById('ladata'+i).checked;
   ...
   new Ajax.Updater(eldiv,'views02/renovacontrato2.php', { 
	            parameters: {elarrego: arrenc,fe1:contraini,fe2:contrafin,polizescoje:polizasele,lapoltiene:titupoliza,laidcontrato:numcontrato} ,   
	            onCreate: function(response) {
                    a= Ajax.activeRequestCount;
                    if(a>=0)
	             $('spinnerP1' ).show(); 
...
function segudnombre(){
 ...
 vardescrip=$F('descripoli');
  new Ajax.Updater('policambio','views02/cambinombpoliza.php', { 
	            parameters: {poliid: varidpoliza,esinterme:varinterme,nuevnombre:varnombre,estatupoli:varestatu,eltipopoli:vartippoliza,ladescrip:vardescrip} ,   
	            onCreate: function(response) {
                    a= Ajax.activeRequestCount;
                    if(a>=0)
	             $('spinnerP1' ).show(); 
