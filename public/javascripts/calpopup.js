...
Calendar.prototype.show = function(e, target, dateFormat, dateFrom, dateTo, menuYearFrom, menuYearTo){
	...
	this.menuYearFrom = menuYearFrom || this.year - 200;
	// When to end the year menu.
	this.menuYearTo = menuYearTo || this.year + 117;
...
Calendar.prototype.buildString = function(){
	...
	tmpStr += '<thead><tr><td colspan="7"><ul>\n'+
			'<li id="cp_prevMonth"><a href="javascript:g_Calendar.changeMonth(-1)" title="Mes Anterior"><span>&lt;</span></a></li>\n'+
			'<li id="cp_monthMenu"><a href="javascript:g_Calendar.openMenuMonths()" title="abri meses del menu">' + this.months[this.month] + '</a>\n' +
			...
			'<li id="cp_nextMonth"><a href="javascript:g_Calendar.changeMonth(1)" title="Mes Siguiente"><span>&gt;</span></a></li>\n' +
			'<li id="cp_prevYear"><a href="javascript:g_Calendar.changeYear(-1)" title="Anterior"><span>&lt;</span></a></li>\n' +
			'<li id="cp_yearMenu"><a href="javascript:g_Calendar.openMenuYears();" title="Abrir Anos del menu">' + this.year + '</a>\n';
	...
	tmpStr += '</ul></li>\n<li id="cp_nextYear"><a href="javascript:g_Calendar.changeYear(1)" title="Siguiente"><span>&gt;</span></a></li>\n</ul></td></tr>';
